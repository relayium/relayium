...
const de: Messages = {
  ...
  me: {
    ...
    deviceNeverUsed: "nie verwendet",
    deviceRevoke: "Widerrufen",
    deviceRevokeLabel: (name, kind) => `${name} (${kind}) widerrufen`,
    deviceConfirmRevoke: (name) => `„${name}“ widerrufen? Sein Anmelde-Token wird sofort ungültig und das Gerät muss sich neu anmelden.`,
    deviceKindApp: "App",
    deviceKindCli: "CLI",
