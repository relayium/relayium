...
const de: Messages = {
  ...
  account: {
    ...
    pendingDeletion: "Ihr Konto ist zur Löschung vorgemerkt. Reaktivieren Sie es, um es zu behalten.",
    reactivate: "Reaktivieren",
    reactivateError: "Reaktivierung fehlgeschlagen — der Link ist möglicherweise abgelaufen. Prüfen Sie Ihre E-Mails auf einen neuen.",
  ...
  billing: {
    ...
    days: (n) => `${n} Tag${n === 1 ? "" : "e"}`,
    currentPlan: "Tarif",
    manageBilling: "Abrechnung verwalten / kündigen",
  ...
  pricingPage: {
    ...
    subtitle: "Übertragungen im selben Netzwerk sind immer kostenlos. Netzübergreifendes Relay und Cloud-Speicher laufen über ein monatliches Kontingent – jedes Konto hat eines, kostenpflichtige Tarife erhöhen es. Und mit einer eigenen Node bleiben Sie zu 100% kostenlos.",
    ...
    a1: "Ja. Übertragungen im selben Netz und direkte CLI-Übertragungen sind Ende-zu-Ende-verschlüsselt, unbegrenzt und völlig kostenlos – zum Empfangen brauchen Sie nicht einmal ein Konto. Netzübergreifendes Relay und Cloud-Speicher zehren von einem Monatskontingent, das jedes Konto hat, auch das kostenlose; Sie zahlen erst, wenn Sie mehr brauchen.",
    q2: "Was ist der Unterschied zwischen direkten und weitergeleiteten Übertragungen?",
    a2: "Eine direkte Übertragung sendet Ihre Datei unmittelbar von einem Gerät zum anderen – am schnellsten und kostenlos; so laufen Browser-Übertragungen im selben Netz und das CLI. Netzübergreifende Browser-Übertragungen laufen über ein verschlüsseltes Relay, damit sie auch durch strenge Firewalls und NATs zuverlässig verbinden – das Relay trägt nur Chiffretext, und die dabei verbrauchte Bandbreite ist das, was Monatskontingent und kostenpflichtige Tarife abdecken.",
  ...
  howItWorks: {
    ...
    offline: {
      ...
      ways: [
        ...
        { icon: "🔗", name: "Download-Link erzeugen", how: "Ablauf von 1 Stunde bis zu 14 Tagen, je nach Tarif oder Löschen nach dem Lesen; der Schlüssel steckt im #-Fragment des Links und erreicht den Server nie.", tag: "Ablauf selbst bestimmen" },
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "Lebensdauer", realtime: "Senden und weg, nichts gespeichert", stored: "Bis zu 14 Tage (je nach Tarif) oder Löschen nach dem Lesen" },
