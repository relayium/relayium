...
const de: Messages = {
  ...
  pricingPage: {
    ...
    free3: "Ende-zu-Ende-verschlüsselt: Dateien sind ohne Größenlimit, Live-Text wird nie gespeichert. Auf direkten Wegen gehen Dateien und Nachrichten unmittelbar von Gerät zu Gerät und berühren nie unsere Server.",
    ...
    a1: "Ja. Datei- oder Live-Text-Übertragungen im selben Netz und direkte CLI-Übertragungen sind Ende-zu-Ende-verschlüsselt und völlig kostenlos — zum Dateiempfang oder Beitritt zu einer Textsitzung brauchst du nicht einmal ein Konto. Dateien haben kein Größenlimit; flüchtiger Text läuft nur live und wird nie gespeichert. Browser-Relay über Netzwerkgrenzen und Cloud-Speicher zehren vom Monatskontingent; du zahlst erst, wenn du mehr brauchst.",
