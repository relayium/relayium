...
const de: Messages = {
  ...
  download: {
    ...
    cli: {
      ...
      windowsNote: "Der POSIX-Block oben deckt Windows nicht ab. Dieser PowerShell-Block wählt das offizielle v0.17.0-Archiv für die CPU, prüft vor dem Entpacken dessen fest hinterlegte SHA-256, führt es aus einem temporären Verzeichnis aus und löscht dieses danach:",
