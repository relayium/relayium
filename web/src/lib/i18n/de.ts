...
const de: Messages = {
  ...
  features: {
    ...
    items: [
      ...
      { title: "Prüfung auf Man-in-the-Middle", desc: "Beide Bildschirme zeigen denselben Browser-SAS; sein Abgleich erkennt ersetzte öffentliche X25519-Endpunktschlüssel oder einen Server, der einen Endpunkt imitiert." },
  ...
  workspace: {
    ...
    lanesNote: "Dateien und Nachrichten teilen sich diese eine geprüfte Verbindung. Der Code wird nur einmal verglichen; jeder Dateisatz und jede Unterhaltung fragt trotzdem einzeln nach Zustimmung.",
