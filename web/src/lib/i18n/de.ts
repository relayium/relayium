...
const de: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Direkte P2P- und Übertragungen im selben Netzwerk sind immer kostenlos. Kostenpflichtige Tarife bieten Cloud-Relay, mehr Speicher und längere Aufbewahrung.",
    signedOutCta: "Melden Sie sich an, um zu abonnieren oder Ihren Tarif zu ändern.",
    faqTitle: "Häufig gestellte Fragen",
    q1: "Ist es wirklich kostenlos?",
    a1: "Ja. Lokale und Peer-to-Peer-Übertragungen sind Ende-zu-Ende-verschlüsselt und unbegrenzt kostenlos. Einen kostenpflichtigen Tarif benötigen Sie nur für weitergeleitete Cloud-Übertragungen mit mehr Speicher und längerer Aufbewahrung.",
    q2: "Kann ich den Tarif später ändern?",
    a2: "Jederzeit. Upgraden oder herabstufen mit einem Klick – Stripe berechnet die Differenz automatisch anteilig, sodass Sie nur für das zahlen, was Sie nutzen.",
    q3: "Wie funktionieren Abrechnung und Kündigung?",
    a3: "Zahlungen werden sicher von Stripe abgewickelt. Sie können jederzeit über „Abrechnung verwalten“ kündigen; Ihr Tarif bleibt bis zum Ende des bezahlten Zeitraums aktiv und wechselt danach zu Free.",
