...
const zh: Messages = {
  ...
  methods: {
    realtime: { name: "实时传输", sub: "选好文件生成 6 位数字码，念码、发链接或扫码任选其一；对方加入即自动开始传输。", badge: "接收方免注册" },
  ...
  compare: {
    title: "两种模式，怎么选",
    sub: "「实时传输」适合双方此刻都在线；「下载链接」适合对方稍后再取。",
    colFeature: "对比项",
    colRealtime: "实时传输",
    colStored: "下载链接",
    rows: [
      { label: "是否需登录", realtime: "跨网文件/文本配对码创建者登录；加入者免账号", stored: "下载链接创建者登录" },
      { label: "对方是否需在线", realtime: "需要，双方同时在线", stored: "不需要，可异步下载" },
      { label: "文件是否经服务器", realtime: "同一网络：设备间直连；跨网络：中继承载无法读取或解密的密文", stored: "是，但仅存零知识密文" },
      { label: "有效期", realtime: "双方在线；无服务端文本记录", stored: "最长 14 天（按套餐），或阅后即焚" },
      { label: "适合场景", realtime: "实时传输大文件或文本", stored: "对方不在线，或一次发多人取" },
    ],
  },
  useCases: {
    title: "适合这些场景",
    ...
    items: [
      { title: "异地发大文件", desc: "把几个 G 的视频、设计稿或数据集直接发给外地的同事或家人，浏览器流式落盘，不占内存、不压缩画质。" },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "文件能多大？", a: "实时文件传输采用流式传输，理论上没有硬性大小上限；下载链接受单文件大小上限与每日额度限制，页面会给出提示。" },
