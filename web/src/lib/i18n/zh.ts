...
const zh: Messages = {
  ...
  pricingPage: {
    navLink: "定价",
    title: "简单、诚实的定价",
    subtitle: "点对点直传和同网络传输始终免费。付费套餐可增加云端中继、更多存储空间和更长的保留时间。",
    signedOutCta: "登录即可订阅或更改套餐。",
    faqTitle: "常见问题",
    q1: "真的免费吗？",
    a1: "是的。本地和点对点传输采用端到端加密，无限量且完全免费。只有需要中继的云端传输、更多存储和更长保留时间时才需要付费套餐。",
    q2: "以后可以更改套餐吗？",
    a2: "随时可以。一键升级或降级——Stripe 会自动按比例结算差价，你只需为实际使用付费。",
    q3: "结算和取消是如何进行的？",
    a3: "付款由 Stripe 安全处理。你可以随时在“管理账单”中取消；套餐在已付费周期结束前保持有效，之后自动恢复为免费版。",
    back: "← 返回 Relayium",
  },
  me: {
    title: "个人中心",
