...
const zh: Messages = {
  ...
  features: {
    ...
    items: [
      ...
      { title: "阅后即焚 · 可控有效期", desc: "下载链接最长可设 7 天有效期（取决于套餐），或首次下载后即焚，不留长期痕迹。" },
    ],
  },
  howItWorks: {
    realtime: {
    ...
    offline: {
      ...
      ways: [
        ...
        { icon: "🔗", name: "生成下载链接", how: "可设 1 小时到最长 7 天有效期（上限取决于套餐），或阅后即焚；解密密钥藏在链接的 # 片段里，不会发送到服务器。", tag: "有效期可控" },
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "有效期", realtime: "即传即走，不留存", stored: "最长 7 天（按套餐），或阅后即焚" },
  ...
  faq: {
    ...
    offline: [
      { q: "下载链接能存多久？", a: "由你设置的有效期决定，从 1 小时到最长 7 天（上限取决于你的套餐），到期自动删除。也可以开启「阅后即焚」，被成功下载一次后立即删除。" },
