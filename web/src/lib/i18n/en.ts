...
const en: Messages = {
  ...
  me: {
    ...
    deviceRevoke: "Revoke",
    deviceRevokeLabel: (name, kind) => `Revoke ${name} (${kind})`,
    deviceConfirmRevoke: (name) => `Revoke “${name}”? Its sign-in token stops working immediately and that device has to sign in again.`,
    deviceKindApp: "App",
    deviceKindCli: "CLI",
