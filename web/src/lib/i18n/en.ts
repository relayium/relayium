...
const en: Messages = {
  ...
  download: {
    ...
    cli: {
      ...
      windowsNote: "The POSIX block above does not cover Windows. This PowerShell block selects the official v0.17.0 archive for your CPU, verifies its pinned SHA-256 before extraction, runs it from a temporary directory, and deletes that directory afterward:",
