...
const en: Messages = {
  ...
  pricingPage: {
    ...
    free3: "End-to-end encrypted: files have no size limit, while live text is never stored. On direct paths, your files and messages go straight between devices — they never touch our servers.",
