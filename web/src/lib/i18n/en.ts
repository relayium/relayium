...
const en: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Direct P2P and same-network transfers are always free. Paid plans add cloud relay, more storage, and longer retention.",
    signedOutCta: "Sign in to subscribe or change your plan.",
    faqTitle: "Frequently asked questions",
    q1: "Is it really free?",
    a1: "Yes. Local and peer-to-peer transfers are end-to-end encrypted and unlimited at no cost. You only need a paid plan for relayed cloud transfers with more storage and longer retention.",
    q2: "Can I change plans later?",
    a2: "Anytime. Upgrade or downgrade in one click — Stripe prorates the difference automatically, so you only pay for what you use.",
    q3: "How does billing and cancellation work?",
    a3: "Payments are handled securely by Stripe. You can cancel anytime from Manage billing; your plan stays active until the end of the paid period, then reverts to Free.",
