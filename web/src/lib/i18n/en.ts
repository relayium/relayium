...
const en: Messages = {
  ...
  billing: {
    ...
    changeError: "Couldn't change your plan. Please try again.",
		paymentPending: "Payment needs action and may expire, so the change has not taken effect. Complete it with Stripe or update your payment method, then try again.",
    compositePaymentPending: "Payment needs action and may expire, so neither change has taken effect and the later cycle switch was not scheduled. Complete it with Stripe or update your payment method, then try again.",
