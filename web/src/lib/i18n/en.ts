...
const en: Messages = {
  ...
  features: {
    ...
    items: [
      ...
      { title: "Man-in-the-middle check", desc: "Both screens show the same browser SAS; matching it detects substituted X25519 endpoint public keys or a server impersonating either endpoint." },
  ...
  workspace: {
    ...
    lanesNote: "Files and messages share this one verified connection. Compare the code once; each file batch and each conversation still asks for its own approval.",
