...
const en: Messages = {
  ...
  why: {
    ...
    selfhostBody: "You can run your own relay / storage node and bind it to your account. What it carries — relayed bytes, and uploads stored on it — stops using your allowance. Downloads Relayium carries for you still count as usual, unless your client fetches them straight from your node.",
