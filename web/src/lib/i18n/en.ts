...
const en: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Same-network transfers are always free. Cross-network relay and cloud storage run on a monthly allowance — every account gets one, and paid plans raise it. You can also stay 100% free by running your own node.",
    ...
    paid1: "Relay bandwidth — cross-network transfers in the browser run through an encrypted relay, so they connect through strict firewalls and NATs. Every account gets a free monthly allowance; paid plans raise it. This uses real bandwidth.",
    ...
    a1: "Yes. Same-network transfers and direct CLI transfers are end-to-end encrypted, unlimited, and completely free — you don't even need an account to receive one. Cross-network relay and cloud storage draw on a monthly allowance that every account gets, Free included; you pay only when you need more.",
    q2: "What's the difference between direct and relayed transfers?",
    a2: "A direct transfer sends your file straight from one device to the other — fastest, and free; that's how same-network browser transfers and the CLI work. Cross-network browser transfers go through an encrypted relay so they connect reliably through strict firewalls and NATs — the relay only ever carries ciphertext, and the bandwidth it uses is what your monthly allowance and paid plans cover.",
