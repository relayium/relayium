...
const en: Messages = {
  ...
  deviceInbox: {
    ...
    sendErrBrowserDeviceLimit: "Nothing was sent: this account already has the maximum of 20 browsers registered for sending. Each new browser, or a browser whose site data was cleared, takes one of these places, and old ones can't yet be removed from the account yourself. Send from a browser that has sent from this account before, or contact support to clear the old ones. Signing in again won't change this.",
