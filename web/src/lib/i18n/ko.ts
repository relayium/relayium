...
const ko: Messages = {
  ...
  crossPitch: "같은 네트워크에서는 'LAN 전송'이 가장 간단합니다. 서로 떨어져 있을 때는 아래 두 가지 방법을 사용하세요.",
  homeCross: {
    title: "같은 네트워크가 아닌가요?",
    desc: "네트워크 간 전송은 로그인 없는 실시간 직접 전송(코드/링크/QR)과 암호화 다운로드 링크를 지원합니다 — 지구 반대편이라도 종단간 암호화로.",
    cta: "네트워크 간 전송으로 이동 →",
  },
