...
const ko: Messages = {
  ...
  features: {
    ...
    items: [
      ...
      { title: "본질적으로 일회성", desc: "다운로드 링크는 최대 7일(요금제에 따라 다름) 후 만료되거나 최초 다운로드 후 소멸하도록 설정해, 흔적을 남기지 않습니다." },
    ],
  },
  howItWorks: {
    realtime: {
    ...
    offline: {
      ...
      ways: [
        ...
        { icon: "🔗", name: "다운로드 링크 생성", how: "유효기간은 1시간~최대 7일(요금제에 따라 다름), 또는 열람 후 삭제. 복호화 키는 링크의 # 프래그먼트에 있으며 서버로 전송되지 않습니다.", tag: "유효기간 직접 설정" },
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "유효 기간", realtime: "보내면 끝, 저장되지 않음", stored: "최대 7일(요금제별), 또는 열람 후 삭제" },
  ...
  faq: {
    ...
    offline: [
      { q: "다운로드 링크는 얼마나 유지되나요?", a: "직접 설정한 유효기간만큼 — 1시간에서 최대 7일까지(상한은 요금제에 따라 다름) — 유지되며, 이후 자동으로 삭제됩니다. 열람 후 삭제를 켜면 한 번 성공적으로 다운로드된 직후 삭제됩니다." },
