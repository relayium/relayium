...
const ko: Messages = {
  ...
  billing: {
    ...
    popular: "가장 인기",
    save2mo: "2개월 무료",
    changeConfirm: (name) => `${name}(으)로 전환할까요? 차액은 다음 청구서에 일할 계산되어 반영됩니다.`,
    downgradeConfirm: (name) => `${name}(으)로 다운그레이드할까요? 현재 청구 기간이 끝날 때 적용됩니다 — 그때까지는 현재 요금제가 유지되며 환불은 없습니다.`,
  ...
  pricingPage: {
    navLink: "요금제",
    title: "간단하고 정직한 요금제",
    subtitle: "P2P 직접 전송과 동일 네트워크 전송은 항상 무료입니다. 유료 요금제는 릴레이 폴백, 클라우드 저장, 더 높은 한도를 추가합니다. 그리고 직접 노드를 운영하면 100% 무료로 이용할 수 있습니다.",
    signedOutCta: "로그인하여 구독하거나 요금제를 변경하세요.",
    freeTitle: "언제나 무료",
    freeLead: "언제까지나 무료로 파일을 전송하세요:",
    free1: "로컬 네트워크(LAN) 전송 — 즉시 전송, 계정 불필요.",
    free2: "직접 연결이 가능할 때는 언제든 인터넷을 통한 직접 피어 투 피어 전송.",
    ...
    paid1: "릴레이 폴백 — 엄격한 방화벽이나 NAT로 직접 연결이 차단되면, 암호화된 스트림을 릴레이하여 전송이 성사되도록 합니다. 이는 실제 대역폭을 사용합니다.",
    ...
    faqTitle: "자주 묻는 질문",
    q1: "정말 무료인가요?",
    a1: "네. LAN과 직접 피어 투 피어 전송은 종단 간 암호화되며 무제한이고 완전히 무료입니다 — 받는 데에는 계정조차 필요 없습니다. 유료 요금제는 릴레이 전송과 클라우드 저장에만 관여합니다.",
    q2: "직접 전송과 릴레이 전송의 차이는 무엇인가요?",
    a2: "직접 전송은 파일을 한 기기에서 다른 기기로 곧바로 보냅니다 — 가장 빠르고 무료입니다. 직접 연결을 맺을 수 없을 때(엄격한 방화벽이나 NAT), Relayium은 암호화된 스트림을 서버를 통해 릴레이하는 방식으로 대체하며, 이는 대역폭을 사용하고 유료 요금제가 감당하는 부분입니다.",
  ...
  crossnet: {
    ...
    realtimeSub: "양쪽 모두 온라인 · P2P · 서버는 파일을 볼 수 없습니다",
  ...
  crossSell: {
    realtime: { lead: "상대가 지금 온라인인가요? 실시간 직접 전송이 더 빠릅니다 — P2P 직결, 서버는 파일을 볼 수 없습니다.", cta: "실시간 직접 전송으로 →" },
  ...
  howItWorks: {
    realtime: {
      ...
      ways: [
        ...
        { icon: "⚡", name: "참여하는 순간 전송 시작", how: "상대가 참여하면 전송이 자동으로 시작됩니다. P2P 직접 연결과 종단간 암호화. 홀 펀칭 실패 시 암호화된 TURN 중계로 전환되지만 복호화는 불가능합니다.", tag: "서버는 파일을 볼 수 없음" },
      ],
    },
    offline: {
      title: "비동기 전송, 3단계",
  ...
  faq: {
    ...
    cross: [
      ...
      { q: "중계로 전환되면 제 파일이 유출될 수 있나요?", a: "아니요. 직접 연결이 불가능하면 암호화된 TURN 중계로 전환되는데, 중계는 암호문만 전달할 뿐 복호화할 수 없어 어떤 파일 내용도 볼 수 없습니다." },
