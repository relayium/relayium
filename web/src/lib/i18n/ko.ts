...
const ko: Messages = {
  ...
  cliPage: {
    ...
    cloudTag: "계정 · 비동기",
    cloudIntro:
      "한 기기에서 올리고 다른 기기에서 원할 때 받습니다 — 둘이 동시에 온라인일 필요가 없습니다. 계정을 쓰는 유일한 모드이며 업로드할 때만입니다: relayium login 을 한 번 한 뒤 up. 다운로드에는 계정이 필요 없습니다. CLI 의 다른 모든 것은 로그인 없이 그대로입니다.",
    cloudBody:
