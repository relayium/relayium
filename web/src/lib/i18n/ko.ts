...
const ko: Messages = {
  ...
  crossnet: {
    ...
    relayQuotaWarn: "이번 달 중계 트래픽을 모두 사용했습니다. P2P 직접 연결은 계속 가능하며 중계 대체 경로만 사용할 수 없습니다. 다음 달 초에 초기화됩니다. 지금 보내려면 다운로드 링크를 이용하세요.",
    relayQuotaFail: "직접 연결에 실패했고 이번 달 중계 트래픽도 모두 사용해 대체할 중계가 없습니다. 다음 달 초에 초기화됩니다. 다운로드 링크를 이용하세요.",
  },
  offline: {
