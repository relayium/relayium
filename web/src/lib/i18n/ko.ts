...
const ko: Messages = {
  ...
  pricingPage: {
    navLink: "요금제",
    title: "간단하고 정직한 요금제",
    subtitle: "P2P 직접 전송과 동일 네트워크 전송은 항상 무료입니다. 유료 요금제는 클라우드 릴레이, 더 많은 저장 공간, 더 긴 보관 기간을 추가합니다.",
    signedOutCta: "로그인하여 구독하거나 요금제를 변경하세요.",
    faqTitle: "자주 묻는 질문",
    q1: "정말 무료인가요?",
    a1: "네. 로컬 및 피어 투 피어 전송은 종단 간 암호화되며 무제한으로 무료입니다. 더 많은 저장 공간과 긴 보관 기간을 제공하는 릴레이 클라우드 전송에만 유료 요금제가 필요합니다.",
    q2: "나중에 요금제를 변경할 수 있나요?",
    a2: "언제든지 가능합니다. 클릭 한 번으로 업그레이드하거나 다운그레이드할 수 있으며, Stripe가 차액을 자동으로 일할 계산하므로 사용한 만큼만 지불합니다.",
    q3: "결제와 해지는 어떻게 이루어지나요?",
    a3: "결제는 Stripe를 통해 안전하게 처리됩니다. ‘결제 관리’에서 언제든지 해지할 수 있으며, 요금제는 결제 기간이 끝날 때까지 유지된 후 무료로 전환됩니다.",
