...
const ja: Messages = {
  ...
  cliPage: {
    badges: ["完全無料", "エンドツーエンド暗号化", "セルフホスト可能"],
    freenote:
      "ファイルはマシン間を直接移動し、Relayium のサーバーを経由することはありません——通過するのは send/receive 時の小さなランデブーハンドシェイクのみです。",
    installH2: "インストール",
    ...
    whichH2: "どのモードを使う？",
    whichIntro: "Relayium には 3 つの転送方法があります。相手先の場所に応じて選んでください:",
    pickWhen: [
      "SSH でログインできるサーバーへ",
      "ネットワークをまたいで他の人へ",
      "自分が所有する 2 台のサーバー間で",
  ...
  crossSell: {
    realtime: { lead: "相手が今オンライン？リアルタイム直接転送の方が速い——P2P直結、ファイルはサーバーを経由しません。", cta: "リアルタイム直接転送へ →" },
  ...
  homeCross: {
    title: "同じネットワークにいない？",
    desc: "相手がオンラインならリアルタイム直接転送（ファイルはサーバー非経由）、オフラインなら非同期転送（暗号化保存・リンクでいつでも取得）。",
