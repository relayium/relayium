...
const pt: Messages = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "O servidor consegue ler ou descriptografar meus arquivos ou mensagens?", a: "Não. Na rede local o tempo real é direto; entre redes o navegador usa TURN por projeto, mas o retransmissor só vê dados cifrados. O Relayium não guarda corpo nem histórico de mensagens, embora as pontas possam reter texto. Links guardam apenas arquivos cifrados." },
