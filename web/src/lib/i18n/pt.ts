...
const pt: Messages = {
  ...
  step1: "Abra esta página em outro dispositivo ou navegador na mesma rede (dispositivos que compartilham uma IP pública formam uma mesma “sala”).",
  ...
  billing: {
    ...
    changeConfirm: (name) => `Mudar para ${name}? A diferença de preço é calculada proporcionalmente na sua próxima fatura.`,
    downgradeConfirm: (name) => `Fazer downgrade para ${name}? A mudança entra em vigor no fim do seu período de faturamento atual — você mantém o plano atual até lá, sem reembolso.`,
  ...
  pricingPage: {
    ...
    subtitle: "Transferências P2P diretas e na mesma rede são sempre gratuitas. Os planos pagos adicionam relay de reserva, armazenamento em nuvem e limites maiores — e você pode continuar 100% grátis hospedando seu próprio nó.",
    ...
    free2: "Transferências diretas ponto a ponto pela internet, sempre que uma conexão direta puder ser feita.",
    ...
    paid1: "Relay de reserva — quando uma conexão direta é bloqueada por um firewall rígido ou NAT, retransmitimos o fluxo criptografado para que a transferência ainda aconteça. Isso usa largura de banda real.",
    ...
    paidWhy: "A largura de banda do relay e o armazenamento em nuvem são nossos únicos custos reais, então é só isso que os planos pagos financiam — sem anúncios, sem venda de dados. É o que mantém o Relayium sustentável e independente.",
    selfhostTitle: "Quer 100% grátis? Hospede seu próprio nó",
    selfhostBody: "O Relayium é de código aberto. Suba seu próprio nó de relay + armazenamento em qualquer máquina que você controle — um VPS, um servidor doméstico, um notebook antigo — com um único comando de instalação. Suas transferências passam pela sua própria infraestrutura, sem limites de uso e sem nada a pagar. Você traz a largura de banda; nós fornecemos o software.",
    selfhostCta: "Adicione um nó na sua conta →",
    faqTitle: "Perguntas frequentes",
    q1: "É realmente grátis?",
    a1: "Sim. As transferências por LAN e diretas ponto a ponto têm criptografia de ponta a ponta, são ilimitadas e totalmente gratuitas — você nem precisa de conta para receber uma. Um plano pago só entra em cena para transferências via relay e armazenamento em nuvem.",
    q2: "Qual é a diferença entre transferências diretas e via relay?",
    a2: "Uma transferência direta envia seu arquivo de um dispositivo para o outro sem intermediários — a mais rápida e grátis. Quando não é possível estabelecer uma conexão direta (firewalls ou NATs rígidos), o Relayium recorre a retransmitir o fluxo criptografado por um servidor, o que usa largura de banda e é o que os planos pagos cobrem.",
    q3: "Por que existe um plano pago?",
    a3: "A largura de banda do relay e o armazenamento em nuvem custam dinheiro de verdade. Em vez de exibir anúncios ou vender dados, cobramos exatamente por esses custos, para que o projeto se mantenha sustentável e independente. Tudo o que é gratuito para operarmos continua gratuito para você.",
    q4: "Posso evitar pagar completamente?",
    a4: "Sim — hospede seu próprio nó. Como o Relayium é de código aberto, você pode hospedar seu próprio relay e armazenamento em hardware que você controla e rotear cada transferência por ele, sem limites e sem taxas. Adicione um na página da sua conta.",
  ...
  cliPage: {
    ...
    whichH2: "Qual modo?",
    whichIntro: "A Relayium move arquivos de algumas maneiras. Escolha pelo lugar onde está a outra ponta — e se ela está online agora:",
    pickWhen: [
    ...
    mode3Tag: "grátis",
    mode3Body:
      "Para dois hosts que você controla e que já conhecem o endereço um do outro: um escuta, o outro faz push direto para ele por TLS 1.3 fixado. Sem retransmissor, sem SSH, sem código — a confiança é por chave pública, configurada uma vez. Três passos:",
    step1Label: "No receptor:",
    step1Body: "inicie o listener — os arquivos enviados chegam ao diretório --dir. Nada para compartilhar antes.",
    ...
    fileDescs: [
      ...
      "impressões digitais dos listeners para os quais você fez push (TOFU, fixadas depois disso).",
      "em um listener, os remetentes de push autorizados a conectar.",
    ],
    ...
    syncNote: "Espelhe uma pasta em um sentido com sincronização incremental — só os arquivos alterados são transferidos. Adicione --delete para espelhar remoções e --watch para re-sincronizar em tempo real. Funciona por SSH e daemon direct.",
  ...
  methods: {
    realtime: { name: "⚡ Direto em tempo real", sub: "Escolha seus arquivos e receba um código de 6 dígitos — diga-o em voz alta, envie o link ou mostre o QR; assim que o outro lado entra, a transferência começa ponto a ponto.", badge: "Destinatário: sem conta" },
  ...
  stored: {
    ...
    cliIntro: "Tem a CLI da Relayium na outra máquina? Monte o comando e cole-o lá:",
  ...
  download: {
    ...
    sendCta: "Envie com segurança pela Relayium →",
  ...
  howItWorks: {
    realtime: {
      ...
      sub: "Quando os dois lados estão online, conectem-se ponto a ponto entre redes — o destinatário não precisa de conta.",
      ways: [
        ...
        { icon: "⚡", name: "A transferência começa ao entrar", how: "No momento em que a pessoa entra, a transferência começa automaticamente — ponto a ponto e com criptografia de ponta a ponta; se o hole-punching falhar, recorre a um retransmissor TURN criptografado que ainda assim não consegue descriptografar nada.", tag: "O servidor nunca vê seus arquivos" },
      ],
    },
    offline: {
  ...
  useCases: {
    ...
    items: [
      ...
      { icon: "🔒", title: "Entrega única sensível à privacidade", desc: "Criptografia de ponta a ponta mais um código de verificação SAS contra intermediário, com apagar após a leitura — ideal para contratos, documentos ou chaves." },
    ],
  },
  faq: {
    ...
    items: [
      ...
      { q: "E se não conectar?", a: "As transferências em tempo real primeiro tentam um caminho ponto a ponto direto (hole-punching por STUN) e recorrem automaticamente a um retransmissor TURN criptografado quando isso falha (o retransmissor só encaminha texto cifrado e não consegue descriptografar). Ainda travado? Um link de download é a opção mais confiável — é assíncrono, então os dois lados não precisam estar online ao mesmo tempo." },
      ...
      { q: "É de código aberto?", a: "Sim. O design do protocolo e todo o código de front-end e back-end são públicos no GitHub — livre para revisar, hospedar por conta própria ou contribuir." },
    ],
    home: [
    ...
    cross: [
      ...
      { q: "Se recorrer a um retransmissor, meu arquivo pode vazar?", a: "Não. Quando não é possível estabelecer um link direto, recorre-se a um retransmissor TURN criptografado, que só encaminha texto cifrado e não consegue descriptografar — ele nunca vê o conteúdo de nenhum arquivo." },
  ...
  homeCross: {
    ...
    desc: "Se a pessoa está online, use o direto em tempo real (ponto a ponto; o servidor nunca vê seus arquivos); se não, use a transferência assíncrona (armazenamento criptografado, busque pelo link a qualquer momento).",
