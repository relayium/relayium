...
const pt: Messages = {
  ...
  step4: "O destinatário aceita; quando os dois códigos de verificação coincidem, começa a transferência de arquivos ou a sessão de texto.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Verificação contra intermediário", desc: "As duas telas mostram o mesmo SAS do navegador; compará-lo detecta a substituição das chaves públicas X25519 das pontas ou um servidor se passando por qualquer ponta." },
  ...
  workspace: {
    ...
    lanesNote: "Arquivos e mensagens compartilham esta única conexão verificada. O código é comparado uma só vez; cada lote de arquivos e cada conversa continuam pedindo a própria aprovação.",
