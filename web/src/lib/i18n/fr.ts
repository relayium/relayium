...
const fr: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Les transferts P2P directs et sur le même réseau sont toujours gratuits. Les forfaits payants ajoutent le relais cloud, plus de stockage et une conservation plus longue.",
    signedOutCta: "Connectez-vous pour vous abonner ou changer de forfait.",
    faqTitle: "Questions fréquentes",
    q1: "Est-ce vraiment gratuit ?",
    a1: "Oui. Les transferts locaux et pair à pair sont chiffrés de bout en bout, illimités et gratuits. Vous n'avez besoin d'un forfait payant que pour les transferts cloud relayés avec plus de stockage et une conservation plus longue.",
    q2: "Puis-je changer de forfait plus tard ?",
    a2: "À tout moment. Passez à un forfait supérieur ou inférieur en un clic — Stripe calcule automatiquement la différence au prorata, vous ne payez donc que ce que vous utilisez.",
    q3: "Comment fonctionnent la facturation et l'annulation ?",
    a3: "Les paiements sont traités en toute sécurité par Stripe. Vous pouvez annuler à tout moment depuis « Gérer la facturation » ; votre forfait reste actif jusqu'à la fin de la période payée, puis revient à Gratuit.",
