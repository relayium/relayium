...
const fr: Messages = {
  ...
  workspace: {
    ...
    lanesNote: "Les fichiers et les messages partagent cette seule connexion vérifiée. Le code ne se compare qu'une fois ; chaque lot de fichiers et chaque conversation demandent malgré tout leur propre accord.",
