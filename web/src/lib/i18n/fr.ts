...
const fr: Messages = {
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "Fichiers via le serveur ?", realtime: "Même réseau : non, d'appareil à appareil. Entre réseaux : via un relais chiffré qui ne voit que du texte chiffré", stored: "Oui, mais uniquement du texte chiffré à divulgation nulle" },
  ...
  faq: {
    ...
    cross: [
      ...
      { q: "Cela passe par votre relais — mon fichier peut-il fuiter ?", a: "Non. Les transferts inter-réseaux passent par un relais TURN chiffré qui ne fait que transmettre du texte chiffré et ne peut pas le déchiffrer — il ne voit jamais le contenu des fichiers." },
