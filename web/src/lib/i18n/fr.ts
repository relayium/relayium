...
const fr: Messages = {
  ...
  pricingPage: {
    ...
    free3: "Chiffrés de bout en bout : aucune limite de taille pour les fichiers, et le texte en direct n'est jamais stocké. Sur les chemins directs, fichiers et messages passent d'un appareil à l'autre sans toucher nos serveurs.",
    ...
    a1: "Oui. Les transferts de fichiers ou de texte en direct sur le même réseau et les transferts directs en CLI sont chiffrés de bout en bout et gratuits — aucun compte n'est requis pour recevoir un fichier ou rejoindre une session texte. Les fichiers n'ont pas de limite de taille ; le texte éphémère exige les deux appareils en ligne et n'est jamais stocké. Le relais inter-réseaux du navigateur et le stockage cloud puisent dans le quota mensuel ; vous ne payez que s'il vous en faut plus.",
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "Durée de vie", realtime: "Envoyé puis disparu, rien de stocké", stored: "Jusqu'à 14 jours (selon l'offre), ou autodestruction après lecture" },
  ...
  text: {
    ...
    ephemeralNote: "Les messages sont chiffrés de bout en bout, jamais stockés sur un serveur, et disparaissent à la fin de la session.",
