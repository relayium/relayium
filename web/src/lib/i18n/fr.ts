...
const fr: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Les transferts sur le même réseau sont toujours gratuits. Le relais inter-réseaux et le stockage cloud fonctionnent avec un quota mensuel — chaque compte en a un, et les offres payantes l'augmentent. Vous pouvez aussi rester 100 % gratuit en hébergeant votre propre nœud.",
    ...
    paid1: "Bande passante du relais — les transferts inter-réseaux dans le navigateur passent par un relais chiffré, ce qui leur permet de traverser pare-feu et NAT stricts. Chaque compte dispose d'un quota mensuel gratuit ; les offres payantes l'augmentent. Cela consomme de la bande passante réelle.",
    ...
    a1: "Oui. Les transferts sur le même réseau et les transferts directs en CLI sont chiffrés de bout en bout, illimités et entièrement gratuits — vous n'avez même pas besoin d'un compte pour en recevoir un. Le relais inter-réseaux et le stockage cloud puisent dans un quota mensuel dont dispose chaque compte, y compris gratuit ; vous ne payez que s'il vous en faut plus.",
    q2: "Quelle est la différence entre les transferts directs et relayés ?",
    a2: "Un transfert direct envoie votre fichier directement d'un appareil à l'autre — le plus rapide, et gratuit ; c'est ainsi que fonctionnent les transferts navigateur sur le même réseau et la CLI. Les transferts navigateur entre réseaux passent par un relais chiffré afin de se connecter de façon fiable à travers pare-feu et NAT stricts — le relais ne transporte que du texte chiffré, et la bande passante consommée est ce que couvrent votre quota mensuel et les offres payantes.",
