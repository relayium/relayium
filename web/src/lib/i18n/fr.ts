...
const fr: Messages = {
  ...
  billing: {
    ...
    days: (n) => `${n} jour${n === 1 ? "" : "s"}`,
    currentPlan: "Offre",
    manageBilling: "Gérer ou résilier",
  ...
  pricingPage: {
    ...
    subtitle: "Les transferts sur le même réseau sont toujours gratuits. Le relais inter-réseaux et le stockage cloud fonctionnent avec un quota mensuel — chaque compte en a un, et les forfaits payants l'augmentent. Vous pouvez aussi rester 100% gratuit en hébergeant votre propre nœud.",
    ...
    paid1: "Bande passante du relais — les transferts inter-réseaux dans le navigateur passent par un relais chiffré, ce qui leur permet de traverser pare-feu et NAT stricts. Chaque compte dispose d'un quota mensuel gratuit ; les forfaits payants l'augmentent. Cela consomme de la bande passante réelle.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Éphémère par conception", desc: "Les liens de téléchargement peuvent expirer sous 14 jours au maximum, selon votre offre, ou se détruire après le premier téléchargement, sans laisser de trace durable." },
    ],
  },
  howItWorks: {
    realtime: {
    ...
    offline: {
      ...
      ways: [
        ...
        { icon: "🔗", name: "Créer le lien de téléchargement", how: "Expiration de 1 heure à 14 jours maximum, selon votre offre, ou destruction après lecture ; la clé de déchiffrement vit dans le fragment # du lien et n'atteint jamais le serveur.", tag: "Expiration maîtrisée" },
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "Fichiers via le serveur ?", realtime: "Même réseau : non, d'appareil à appareil. Entre réseaux : via un relais chiffré qui ne voit que du chiffré", stored: "Oui, mais uniquement du chiffré à divulgation nulle" },
      { label: "Durée de vie", realtime: "Envoyé puis disparu, rien de stocké", stored: "Jusqu'à 14 jours (selon l'offre), ou destruction après lecture" },
  ...
  faq: {
    ...
    cross: [
      ...
      { q: "Ça passe par votre relais — mon fichier peut-il fuiter ?", a: "Non. Les transferts inter-réseaux passent par un relais TURN chiffré qui ne fait que transmettre du texte chiffré et ne peut pas le déchiffrer — il ne voit jamais le contenu des fichiers." },
