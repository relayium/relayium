...
const es: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Las transferencias P2P directas y en la misma red siempre son gratuitas. Los planes de pago añaden relay en la nube, más almacenamiento y mayor retención.",
    signedOutCta: "Inicia sesión para suscribirte o cambiar de plan.",
    faqTitle: "Preguntas frecuentes",
    q1: "¿De verdad es gratis?",
    a1: "Sí. Las transferencias locales y entre pares están cifradas de extremo a extremo y son ilimitadas sin coste. Solo necesitas un plan de pago para las transferencias en la nube con relay, más almacenamiento y mayor retención.",
    q2: "¿Puedo cambiar de plan más adelante?",
    a2: "Cuando quieras. Sube o baja de plan con un clic: Stripe prorratea la diferencia automáticamente, así que solo pagas por lo que usas.",
    q3: "¿Cómo funcionan la facturación y la cancelación?",
    a3: "Los pagos se gestionan de forma segura con Stripe. Puedes cancelar cuando quieras desde Gestionar facturación; tu plan sigue activo hasta el final del periodo pagado y luego vuelve a Gratis.",
