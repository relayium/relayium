...
const es: Messages = {
  ...
  pricingPage: {
    ...
    subtitle: "Las transferencias en la misma red siempre son gratuitas. La retransmisión entre redes y el almacenamiento en la nube funcionan con una cuota mensual: todas las cuentas tienen una y los planes de pago la amplían. Además, puedes seguir siendo 100% gratis alojando tu propio nodo.",
    ...
    free2: "Transferencias directas de igual a igual con la CLI — por tu propio SSH, daemon directo o un código de emparejamiento — sin medición. Solo generar un código de emparejamiento para send necesita cuenta; recibir nunca la necesita.",
    ...
    paid1: "Ancho de banda de retransmisión: las transferencias entre redes en el navegador pasan por un retransmisor cifrado, de modo que atraviesan cortafuegos y NAT estrictos. Cada cuenta tiene una cuota mensual gratuita y los planes de pago la amplían. Esto consume ancho de banda real.",
