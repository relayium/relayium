...
const es: Messages = {
  ...
  cliPage: {
    ...
    flagMeanings: [
      ...
      "Omite la confirmación del SAS (sesiones `text` en scripts).",
    ...
    textSasNote: "El SAS se confirma por omisión. Una ejecución con tubería no tiene a quién preguntar, así que se niega a empezar salvo que pases --yes tras comparar el código por otra vía.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Comprobación contra intermediarios", desc: "Ambas pantallas muestran el mismo SAS del navegador; compararlo detecta la sustitución de las claves públicas X25519 de los extremos o que un servidor suplante a cualquiera de ellos." },
  ...
  workspace: {
    ...
    lanesNote: "Los archivos y los mensajes comparten esta única conexión verificada. El código se compara una sola vez; cada lote de archivos y cada conversación siguen pidiendo su propia aprobación.",
