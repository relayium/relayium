...
const es: Messages = {
  ...
  pricingPage: {
    ...
    free3: "Cifradas de extremo a extremo: los archivos no tienen límite de tamaño y el texto en vivo nunca se almacena. Por rutas directas, archivos y mensajes van entre dispositivos sin tocar nuestros servidores.",
    ...
    a1: "Sí. Las transferencias de archivos o texto en vivo en la misma red y las directas por CLI están cifradas de extremo a extremo y son gratuitas; no necesitas cuenta para recibir un archivo o unirte a una sesión de texto. Los archivos no tienen límite de tamaño; el texto efímero exige que ambos estén conectados y nunca se almacena. La retransmisión del navegador entre redes y el almacenamiento en la nube consumen la cuota mensual; solo pagas si necesitas más.",
  ...
  cliPage: {
    ...
    textIntro: "En una máquina, relayium text crea un código y espera; la otra se une con el comando impreso relayium text CODE. Ambas permanecen en línea. Los mensajes están cifrados de extremo a extremo, nunca se guardan en ningún servidor y desaparecen al terminar la sesión.",
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "Duración", realtime: "Envía y desaparece, nada almacenado", stored: "Hasta 14 días (según el plan), o destrucción tras la lectura" },
  ...
  text: {
    ...
    ephemeralNote: "Los mensajes están cifrados de extremo a extremo, nunca se guardan en ningún servidor y desaparecen al terminar la sesión.",
