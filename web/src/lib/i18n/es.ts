...
const es: Messages = {
  ...
  magicLink: {
    title: "Inicia sesión en Relayium",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "¿Puede el servidor leer o descifrar mis archivos o mensajes?", a: "No. En la red local el tiempo real es directo; entre redes el navegador usa TURN por diseño, pero el retransmisor solo ve datos cifrados. Relayium no guarda cuerpos ni historial de mensajes, aunque los extremos pueden conservar texto. Los enlaces guardan únicamente archivos cifrados." },
    ...
    cross: [
      ...
      { q: "¿Ambos lados tienen que estar en línea al mismo tiempo?", a: "Sí. Una transferencia en tiempo real entre redes necesita que el remitente y el destinatario estén en línea juntos con la página abierta. Si no es posible que ambos lados estén en línea a la vez, usa un enlace de descarga asíncrono — almacena el archivo cifrado para que el otro lado lo recoja después." },
      ...
      { q: "Pasa por el retransmisor de Relayium, ¿podría filtrarse mi archivo?", a: "No. Las transferencias entre redes pasan por un retransmisor TURN cifrado, que solo reenvía texto cifrado y no puede descifrar — nunca ve el contenido de ningún archivo." },
      ...
      { q: "¿Qué determina la velocidad y cómo la hago más rápida?", a: "En un enlace directo son el ancho de banda de subida/bajada y la latencia de las dos redes; vía retransmisor influye también el ancho de banda del nodo retransmisor. Desplegar tu propio nodo desde la página de cuenta puede acelerar notablemente la retransmisión entre redes — y es gratis." },
    ],
    offline: [
