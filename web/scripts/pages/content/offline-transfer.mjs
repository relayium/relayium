  ...
  why: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Use this when the other side isn't online right now; use cross-network transfer, live and across networks, when both are present.",
      },
    ],
  },
  compare: {
...
const zh = {
  ...
  why: {
    ...
    items: [
      ...
      {
        title: "异步场景的补充",
        desc: "当对方暂时不在线时使用；若双方同时在线，可改用实时的「跨网络传输」。",
      },
      {
        title: "也能用命令行",
