  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "طريقة تسجيل الدخول التي استخدمتها (Google، أو رابط سحري عبر البريد الإلكتروني، أو البريد الإلكتروني + كلمة المرور). تُخزَّن رموز الرابط السحري على هيئة تجزئة فقط، ولا تُخزَّن أبدًا كنص صريح؛ وإذا ضبطت كلمة مرور، فإننا نخزّن تجزئة bcrypt الخاصة بها فقط، ولا نخزّن كلمة المرور نفسها أبدًا.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "مزوّد لتوصيل البريد الإلكتروني، لإرسال رسائل تسجيل الدخول عبر الرابط السحري.",
      ],
    },
    {
      heading: "الاحتفاظ بالبيانات وحذفها",
      body: [
        "يُحتفَظ ببيانات الحساب طوال وجود حسابك. ويمكنك أن تطلب منّا حذف حسابك وبياناته في أي وقت عبر مراسلتنا على support@relayium.com.",
      ],
    },
    {
