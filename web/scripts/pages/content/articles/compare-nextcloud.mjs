  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "No. In realtime mode nothing is stored anywhere — the file goes directly between devices. Stored links keep zero-knowledge ciphertext only until they expire (1 hour to 7 days) or are downloaded once with burn-after-read, not indefinitely like a Nextcloud share.",
      },
      {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "生成这样的存储链接需要发送方登录；收件方下载无需任何账号。每个链接都可设为 1 小时、1 天、3 天或 7 天后过期，或者首次完整下载后即焚——它不是像 Nextcloud 分享那样的永久归宿，它本来就是为了消失而存在的。",
      ],
    },
    {
      heading: "功能一览对比",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "不会。实时模式下什么都不会被存储在任何地方——文件在设备之间直接传输。存储链接只会保留无法解读的零知识密文，直到它过期（1 小时到 7 天）或被下载一次后即焚，而不是像 Nextcloud 分享那样无限期保存。",
      },
      {
        q: "我需要账号吗？",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "こうした保存リンクの作成には送信側のサインインが必要です。受信側はダウンロードにアカウントが要りません。各リンクは1時間、1日、3日、7日で期限切れになるよう設定でき、あるいは最初の完全なダウンロード後に消去するよう設定できます——Nextcloud の共有のような恒久的な置き場所ではなく、消えることを前提としています。",
      ],
    },
    {
      heading: "機能の一覧比較",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "いいえ。リアルタイムモードでは何もどこにも保存されません——ファイルは端末間を直接移動します。保存リンクは、期限切れ（1時間から7日）になるか、バーン・アフター・リードで1回ダウンロードされるまでの間だけゼロ知識の暗号文を保持し、Nextcloud の共有のように無期限には保存されません。",
      },
      {
        q: "アカウントは必要ですか？",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "아니요. 실시간 모드에서는 아무것도 어디에도 저장되지 않습니다 — 파일은 기기 사이를 직접 이동합니다. 저장 링크는 만료되거나(1시간~7일) 소각형 다운로드로 한 번 받아질 때까지만 영지식 암호문을 보관하며, Nextcloud 공유처럼 무기한 보관되지 않습니다.",
      },
      {
        q: "계정이 필요한가요?",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Nein. Im Echtzeitmodus wird nirgendwo etwas gespeichert — die Datei wandert direkt zwischen den Geräten. Gespeicherte Links halten Zero-Knowledge-Chiffretext nur so lange, bis er abläuft (1 Stunde bis 7 Tage) oder mit Burn-after-Read einmal heruntergeladen wird, nicht dauerhaft wie eine Nextcloud-Freigabe.",
      },
      {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "يتطلب إنشاء رابط مُخزَّن من المُرسِل تسجيل الدخول؛ ولا يحتاج المُستقبِل حساباً للتنزيل. يمكن ضبط كل رابط لينتهي بعد ساعة واحدة أو يوم واحد أو 3 أيام أو 7 أيام، أو ليُحرَق بعد أول تنزيل كامل — فهو ليس بيتاً دائماً للملف مثل مشاركة Nextcloud، بل قُصِد له أن يختفي.",
      ],
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "لا. في الوضع الفوري لا يُخزَّن شيء في أي مكان — يذهب الملف مباشرة بين الأجهزة. تحتفظ الروابط المُخزَّنة بنص مُشفَّر بمعرفة صفرية فقط حتى تنتهي (من ساعة إلى 7 أيام) أو تُنزَّل مرة واحدة مع الحرق بعد القراءة، لا إلى أجل غير مسمى كمشاركة Nextcloud.",
      },
      {
        q: "هل أحتاج إلى حساب؟",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Crear un enlace almacenado requiere que el remitente inicie sesión; el destinatario no necesita cuenta para descargar. Cada enlace puede configurarse para expirar tras 1 hora, 1 día, 3 días o 7 días, o para destruirse tras la primera descarga completa — no pretende ser un hogar permanente para el archivo como un recurso compartido de Nextcloud, está pensado para desaparecer.",
      ],
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "No. En modo en tiempo real no se almacena nada en ningún lado — el archivo va directamente entre dispositivos. Los enlaces almacenados conservan texto cifrado de conocimiento cero solo hasta que expiran (de 1 hora a 7 días) o se descargan una vez con destrucción tras la lectura, no indefinidamente como un recurso compartido de Nextcloud.",
      },
      {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Criar um link armazenado exige que o remetente faça login; o destinatário não precisa de conta para baixar. Cada link pode ser configurado para expirar após 1 hora, 1 dia, 3 dias ou 7 dias, ou para se autodestruir após o primeiro download completo — ele não pretende ser um lar permanente para o arquivo como um compartilhamento do Nextcloud, ele foi feito para desaparecer.",
      ],
    },
    {
