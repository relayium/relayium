  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Cost and openness: Relayium is open source under AGPL-3.0 at github.com/relayium/relayium, with same-network transfers free, and hosted relay and storage bounded by a monthly traffic allowance plus a separate cap on how much you keep stored at once, both of which paid plans raise; Nextcloud's server software is also free and open source (AGPL), with paid hosting and support available from Nextcloud GmbH and partners.",
      ],
    },
  ],
  faq: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "费用与开放：Relayium 采用 AGPL-3.0 许可开源，代码在 github.com/relayium/relayium，同一网络内的传输免费，托管中继与存储受每月流量额度以及同时存放的数据量上限这两项独立限制约束、付费套餐两者都更高；Nextcloud 的服务端软件同样免费开源（AGPL 许可），Nextcloud GmbH 及其合作伙伴也提供付费的托管与支持服务。",
      ],
    },
  ],
  faq: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "費用と開放性：Relayium は AGPL-3.0 ライセンスのオープンソースで github.com/relayium/relayium にあります。同じネットワーク内の転送は無料で、ホスト型の中継と保存は月間転送量の枠と、同時に保存しておける量に対する別のストレージ上限に制約され、有料プランではその両方が引き上げられます。Nextcloud のサーバーソフトウェアも無料でオープンソース（AGPL）ですが、Nextcloud GmbH やパートナーによる有料のホスティングとサポートも利用できます。",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium は無料ですか？",
        a: "ソフトウェアは AGPL-3.0 ライセンスの無料オープンソースで、同じネットワーク内の転送も無料です。ホスト型の中継と保存は、どのアカウントにもある2つの枠で動作します。月間転送量の枠と、同時に保存しておける量に対する別のストレージ上限で、有料プランではその両方が引き上げられます。Nextcloud のコアサーバーソフトウェアも無料でオープンソースですが、Nextcloud GmbH による一部のホスティングとサポートは有料です。",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "비용과 개방성: Relayium은 AGPL-3.0 라이선스의 오픈소스로 github.com/relayium/relayium에 있습니다. 같은 네트워크 안의 전송은 무료이고, 호스팅된 중계와 저장은 월간 트래픽 허용량과 한 번에 저장해 둘 수 있는 양에 대한 별도의 저장 용량 한도를 따르며, 유료 요금제는 둘 다 높여 줍니다. Nextcloud의 서버 소프트웨어도 무료 오픈소스(AGPL)이지만, Nextcloud GmbH와 파트너사가 제공하는 유료 호스팅과 지원도 이용할 수 있습니다.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium은 무료인가요?",
        a: "소프트웨어는 AGPL-3.0 라이선스의 무료 오픈소스이고, 같은 네트워크 안의 전송도 무료입니다. 호스팅된 중계와 저장은 모든 계정에 주어지는 두 가지 한도를 따릅니다. 월간 트래픽 허용량, 그리고 한 번에 저장해 둘 수 있는 양에 대한 별도의 저장 용량 한도이며, 유료 요금제는 둘 다 높여 줍니다. Nextcloud의 코어 서버 소프트웨어도 무료 오픈소스이지만, Nextcloud GmbH가 제공하는 일부 호스팅과 지원은 유료입니다.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Kosten und Offenheit: Relayium ist Open Source unter der AGPL-3.0-Lizenz auf github.com/relayium/relayium; Übertragungen im selben Netz sind kostenlos, und gehostetes Relaying und gehosteter Speicher sind durch ein monatliches Datenkontingent und ein separates Speicherlimit dafür begrenzt, wie viel du gleichzeitig gespeichert hältst — bezahlte Tarife erhöhen beides. Nextclouds Server-Software ist ebenfalls kostenlos und quelloffen (AGPL), mit bezahltem Hosting und Support von Nextcloud GmbH und Partnern.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Die Software ist kostenlos und Open Source unter der AGPL-3.0-Lizenz, und Übertragungen im selben Netz kosten nichts. Gehostetes Relaying und gehosteter Speicher laufen auf Limits, die jedes Konto hat: ein monatliches Datenkontingent und ein separates Speicherlimit dafür, wie viel du gleichzeitig gespeichert hältst; bezahlte Tarife erhöhen beides. Nextclouds Kern-Server-Software ist ebenfalls kostenlos und quelloffen; manche Hosting- und Support-Optionen von Nextcloud GmbH sind kostenpflichtig.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coût et ouverture : Relayium est open source sous licence AGPL-3.0 sur github.com/relayium/relayium ; les transferts sur le même réseau sont gratuits, et le relais et le stockage hébergés sont bornés par un quota de trafic mensuel et une limite de stockage distincte pour ce que vous gardez stocké à la fois, que les offres payantes relèvent toutes les deux ; le logiciel serveur de Nextcloud est lui aussi gratuit et open source (AGPL), avec de l'hébergement et du support payants disponibles auprès de Nextcloud GmbH et de partenaires.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Le logiciel est gratuit et open source sous licence AGPL-3.0, et les transferts sur le même réseau ne coûtent rien. Le relais et le stockage hébergés fonctionnent dans des limites dont dispose chaque compte : un quota de trafic mensuel, et une limite de stockage distincte pour ce que vous gardez stocké à la fois, que les offres payantes relèvent toutes les deux. Le logiciel serveur cœur de Nextcloud est lui aussi gratuit et open source ; certaines options d'hébergement et de support de Nextcloud GmbH sont payantes.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "التكلفة والانفتاح: إن Relayium مفتوح المصدر ومرخَّص بـ AGPL-3.0 على github.com/relayium/relayium، والنقل على نفس الشبكة مجاني، أما الترحيل والتخزين المُستضافان فتحدّهما حصة حركة البيانات الشهرية وحدّ تخزين منفصل لما تحتفظ به مُخزَّنًا في آنٍ واحد، والخطط المدفوعة ترفع كليهما؛ وبرنامج خادم Nextcloud مجاني ومفتوح المصدر أيضًا (AGPL)، مع استضافة ودعم مدفوعين متاحين من Nextcloud GmbH وشركائها.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "هل Relayium مجاني؟",
        a: "البرنامج مجاني ومفتوح المصدر بموجب ترخيص AGPL-3.0، والنقل على نفس الشبكة لا يكلّف شيئًا. أما الترحيل والتخزين المُستضافان فيعملان ضمن حدود يحصل عليها كل حساب: حصة حركة البيانات الشهرية، وحدّ تخزين منفصل لما تحتفظ به مُخزَّنًا في آنٍ واحد، والخطط المدفوعة ترفع كليهما. وبرنامج خادم Nextcloud الأساسي مجاني ومفتوح المصدر أيضًا؛ لكن بعض خيارات الاستضافة والدعم من Nextcloud GmbH مدفوعة.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coste y apertura: Relayium es de código abierto con licencia AGPL-3.0 en github.com/relayium/relayium; las transferencias en la misma red son gratis, y la retransmisión y el almacenamiento alojados están limitados por una franquicia mensual de tráfico y un límite de almacenamiento aparte para lo que guardas almacenado a la vez, y los planes de pago amplían ambos; el software de servidor de Nextcloud también es gratis y de código abierto (AGPL), con alojamiento y soporte de pago disponibles de Nextcloud GmbH y socios.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "El software es gratis y de código abierto bajo la licencia AGPL-3.0, y las transferencias en la misma red no cuestan nada. La retransmisión y el almacenamiento alojados funcionan con límites que tiene cada cuenta: una franquicia mensual de tráfico y un límite de almacenamiento aparte para lo que guardas almacenado a la vez, y los planes de pago amplían ambos. El software de servidor central de Nextcloud también es gratis y de código abierto; algunas opciones de alojamiento y soporte de Nextcloud GmbH son de pago.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Custo e abertura: o Relayium é de código aberto sob a licença AGPL-3.0 em github.com/relayium/relayium; transferências na mesma rede são gratuitas, e a retransmissão e o armazenamento hospedados são limitados por uma cota mensal de tráfego e um limite de armazenamento separado para o que você mantém armazenado ao mesmo tempo, e os planos pagos aumentam ambos; o software de servidor do Nextcloud também é gratuito e de código aberto (AGPL), com hospedagem e suporte pagos disponíveis pela Nextcloud GmbH e parceiros.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "O software é gratuito e de código aberto sob a licença AGPL-3.0, e as transferências na mesma rede não custam nada. A retransmissão e o armazenamento hospedados funcionam com limites que toda conta tem: uma cota mensal de tráfego e um limite de armazenamento separado para o que você mantém armazenado ao mesmo tempo, e os planos pagos aumentam ambos. O software de servidor central do Nextcloud também é gratuito e de código aberto; algumas opções de hospedagem e suporte da Nextcloud GmbH são pagas.",
      },
    ],
  },
  cta: {
