...
const ar = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "هل Relayium مجاني؟",
        a: "نعم — مجاني ومفتوح المصدر بموجب ترخيص AGPL-3.0، بلا فئة مدفوعة. وبرنامج خادم Nextcloud الأساسي مجاني ومفتوح المصدر أيضاً؛ لكن بعض خيارات الاستضافة والدعم من Nextcloud GmbH مدفوعة.",
      },
    ],
  },
  cta: {
