  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Cost and license: both free; scp ships with OpenSSH, Relayium's CLI is MIT-licensed and open source.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes, completely — no paid tier, MIT-licensed and open source, and every mode connects the two ends directly.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "费用与许可：两者都免费；scp 随 OpenSSH 一起提供，Relayium 的 CLI 采用 MIT 许可并开源。",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "完全免费——没有付费档位，MIT 许可并开源，每种模式都是两端直接连接。",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "費用とライセンス：どちらも無料；scp は OpenSSH に付属し、Relayium の CLI は MIT ライセンスでオープンソース。",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "はい、完全に無料です——有料プランはなく、MIT ライセンスでオープンソース、どのモードでも両端が直接つながります。",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "비용과 라이선스: 둘 다 무료; scp는 OpenSSH와 함께 제공되고, Relayium의 CLI는 MIT 라이선스로 오픈소스임.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "네, 완전히 무료입니다 — 유료 등급이 없고, MIT 라이선스로 오픈소스이며, 모든 모드가 양쪽을 직접 연결합니다.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Kosten und Lizenz: beide kostenlos; scp wird mit OpenSSH ausgeliefert, Relayiums CLI ist MIT-lizenziert und quelloffen.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Ja, vollständig — keine bezahlte Stufe, MIT-lizenziert und quelloffen, und jeder Modus verbindet die beiden Enden direkt.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coût et licence : les deux sont gratuits ; scp est fourni avec OpenSSH, la CLI Relayium est sous licence MIT et open source.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Oui, entièrement — aucun palier payant, sous licence MIT et open source, et chaque mode connecte directement les deux extrémités.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "التكلفة والترخيص: كلاهما مجاني؛ scp يأتي مع OpenSSH، وواجهة Relayium السطرية مرخّصة بـ MIT ومفتوحة المصدر.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "نعم، بالكامل — لا فئة مدفوعة، مرخّصة بـ MIT ومفتوحة المصدر، وكل وضع يصل الطرفين مباشرةً.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coste y licencia: ambos gratis; scp viene con OpenSSH, la CLI de Relayium está bajo licencia MIT y es de código abierto.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Sí, por completo: sin nivel de pago, con licencia MIT y de código abierto, y cada modo conecta ambos extremos directamente.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Custo e licença: ambos gratuitos; o scp vem com o OpenSSH, a CLI do Relayium é licenciada sob MIT e de código aberto.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Sim, totalmente — sem nível pago, licenciada sob MIT e de código aberto, e cada modo conecta as duas pontas diretamente.",
      },
    ],
  },
  cta: {
