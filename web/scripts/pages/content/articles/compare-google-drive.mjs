...
const zh = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium 免费吗？",
        a: "软件免费，同一网络内的传输也免费。Relayium 采用 AGPL-3.0 许可，是开源软件，完整的协议与代码都在 github.com/relayium/relayium；同一网络内的浏览器传输免费，且不限文件大小。跨网络中继与存储下载链接会占用每个账号都有的额度：每月流量额度，以及同时存放的数据量上限，这两项彼此独立。付费套餐两者都更高——你也可以运行自己的节点，让经它中继的字节和存到它上面的上传不再占用每月流量额度，不过这些文件仍计入存储上限，由 Relayium 转发的下载也照常计入。",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "費用と開放性：Relayium は AGPL-3.0 ライセンスのオープンソースで github.com/relayium/relayium にあり、ブラウザで Windows・macOS・Linux・Android・iOS で動作し、インストールは不要です。同じネットワーク内の転送は無料です。ネットワークをまたぐ中継と保存リンクはプランの月間転送量の枠を消費し、同時に保存しておける量には別のストレージ上限があります。有料プランではその両方が引き上げられます。",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium は無料ですか？",
        a: "ソフトウェアは無料で、同じネットワーク内の転送も無料です。Relayium は AGPL-3.0 ライセンスのオープンソースで、プロトコルとコードのすべてが github.com/relayium/relayium にあり、同じネットワーク内のブラウザ転送は無料でサイズ制限もありません。ネットワークをまたぐ中継と保存ダウンロードリンクは、どのアカウントにもある2つの枠を使います。月間転送量の枠と、同時に保存しておける量に対する別のストレージ上限です。有料プランではその両方が引き上げられます。",
      },
    ],
  },
  cta: {
...
const ko = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium은 무료인가요?",
        a: "소프트웨어는 무료이고, 같은 네트워크 안의 전송도 무료입니다. Relayium은 AGPL-3.0 라이선스의 오픈소스이며, 프로토콜과 코드 전체가 github.com/relayium/relayium에 있고, 같은 네트워크 안의 브라우저 전송은 무료이며 크기 제한도 없습니다. 네트워크를 넘는 중계와 저장 다운로드 링크는 모든 계정에 주어지는 두 가지 한도를 씁니다. 월간 트래픽 허용량, 그리고 한 번에 저장해 둘 수 있는 양에 대한 별도의 저장 용량 한도입니다. 유료 요금제는 둘 다 높여 줍니다.",
      },
    ],
  },
  cta: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Die Software ja, und Übertragungen im selben Netz ebenfalls. Relayium ist quelloffen unter der AGPL-3.0-Lizenz, mit dem vollständigen Protokoll und Code unter github.com/relayium/relayium, und Browser-Übertragungen im selben Netz sind kostenlos und ohne Größenlimit. Netzübergreifendes Relaying und gespeicherte Download-Links nutzen Limits, die jedes Konto hat: ein monatliches Datenkontingent und ein separates Speicherlimit dafür, wie viel du gleichzeitig gespeichert hältst. Bezahlte Tarife erhöhen beides.",
      },
    ],
  },
  cta: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Le logiciel, oui, et les transferts sur le même réseau aussi. Relayium est open source sous licence AGPL-3.0, avec l'intégralité du protocole et du code sur github.com/relayium/relayium, et les transferts dans le navigateur sur le même réseau sont gratuits et sans limite de taille. Le relais entre réseaux et les liens de téléchargement stockés puisent dans des limites dont dispose chaque compte : un quota de trafic mensuel, et une limite de stockage distincte pour ce que vous gardez stocké à la fois. Les offres payantes relèvent les deux.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "التكلفة والانفتاح: Relayium مفتوح المصدر بموجب رخصة AGPL-3.0 على github.com/relayium/relayium، ويعمل في المتصفح على Windows وmacOS وLinux وAndroid وiOS دون أي شيء يُثبَّت. النقل على نفس الشبكة مجاني؛ أما الترحيل عبر الشبكات والروابط المُخزَّنة فيستهلك حصة حركة البيانات الشهرية في خطتك، مع حدّ تخزين منفصل لما تحتفظ به مُخزَّنًا في آنٍ واحد، والخطط المدفوعة ترفع كليهما.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "هل Relayium مجاني؟",
        a: "البرنامج مجاني، وكذلك النقل على نفس الشبكة. Relayium مفتوح المصدر بموجب رخصة AGPL-3.0، مع البروتوكول والشيفرة كاملةً على github.com/relayium/relayium، والنقل عبر المتصفّح على نفس الشبكة مجاني وبلا حدّ للحجم. أما الترحيل عبر الشبكات وروابط التنزيل المُخزَّنة فتستهلك حدودًا يحصل عليها كل حساب: حصة حركة البيانات الشهرية، وحدّ تخزين منفصل لما تحتفظ به مُخزَّنًا في آنٍ واحد. والخطط المدفوعة ترفع كليهما.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coste y apertura: Relayium es de código abierto con licencia AGPL-3.0 en github.com/relayium/relayium, funcionando en el navegador en Windows, macOS, Linux, Android e iOS sin nada que instalar. Las transferencias en la misma red son gratis; la retransmisión entre redes y los enlaces almacenados consumen la franquicia mensual de tráfico de tu plan, con un límite de almacenamiento aparte para lo que guardas almacenado a la vez, y los planes de pago amplían ambos.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "El software sí, y también las transferencias en la misma red. Relayium es de código abierto bajo la licencia AGPL-3.0, con el protocolo y el código completos en github.com/relayium/relayium, y las transferencias en el navegador dentro de la misma red son gratis y sin límite de tamaño. La retransmisión entre redes y los enlaces de descarga almacenados usan límites que tiene cada cuenta: una franquicia mensual de tráfico y un límite de almacenamiento aparte para lo que guardas almacenado a la vez. Los planes de pago amplían ambos.",
      },
    ],
  },
  cta: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "O software sim, e as transferências na mesma rede também. O Relayium é de código aberto sob a licença AGPL-3.0, com o protocolo e o código completos em github.com/relayium/relayium, e as transferências no navegador na mesma rede são gratuitas e sem limite de tamanho. A retransmissão entre redes e os links de download armazenados usam limites que toda conta tem: uma cota mensal de tráfego e um limite de armazenamento separado para o que você mantém armazenado ao mesmo tempo. Os planos pagos aumentam ambos.",
      },
    ],
  },
  cta: {
