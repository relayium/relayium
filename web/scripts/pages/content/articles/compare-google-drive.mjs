  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "التكلفة والانفتاح: Relayium مجاني ومرخّص بموجب MIT على github.com/relayium/relayium، ويعمل في المتصفح على Windows و macOS و Linux و Android و iOS دون أي شيء يُثبَّت.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "هل Relayium مجاني؟",
        a: "نعم. Relayium مجاني ومفتوح المصدر بموجب رخصة MIT، والبروتوكول والشيفرة بالكامل على github.com/relayium/relayium — دون طبقة مدفوعة لفتح عمليات نقل أكبر أو أسرع.",
      },
    ],
  },
  cta: {
