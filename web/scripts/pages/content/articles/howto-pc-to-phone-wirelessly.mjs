  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "宛先にスマホを選んで開始します。両方の端末が同じ6桁の確認コード（SAS）を表示します。ちらっと見て一致を確かめれば、ファイルが飛んでいきます。",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Relayium：無線、インストール不要、リアルタイム転送はアカウント不要、再圧縮なし（ファイルごとの SHA-256 整合性チェック付きでバイト単位）、そして自分で確認できる確認コード付きのエンドツーエンド暗号化。",
      ],
    },
  ],
  faq: {
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "대상으로 휴대폰을 고르고 시작합니다. 두 기기가 동일한 6자리 확인 코드(SAS)를 표시합니다. 힐끗 보고 일치를 확인하면 파일이 날아갑니다.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Relayium: 무선, 설치 불필요, 실시간 전송은 계정 불필요, 재압축 없음(파일별 SHA-256 무결성 검사와 함께 바이트 단위), 그리고 직접 확인할 수 있는 확인 코드가 있는 종단간 암호화.",
      ],
    },
  ],
  faq: {
