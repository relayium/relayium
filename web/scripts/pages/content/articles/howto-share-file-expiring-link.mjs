...
const en = {
  ...
  description:
    "Encrypt a file in your browser and get a link the server can't decrypt. Choose 1 hour, 1 day, 3 days, or 7 days, or burn after the first download, then send it whenever you're ready.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "You choose when you create the link: 1 hour, 1 day, 3 days, or 7 days, or you can set it to burn after the first complete download instead of a fixed expiry. After that point the link stops working.",
      },
      {
...
const zh = {
  title: "用会过期的安全链接分享文件",
  description:
    "在浏览器里加密文件，生成一个连服务器都解不开的链接。可选 1 小时、1 天、3 天、7 天有效期,或首次下载后即焚——你准备好了再发。",
  updatedLabel: "最近更新",
  lead: [
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: ["1 小时", "1 天(默认)", "3 天", "7 天", "或者:首次完整下载后即焚,而不是固定时长"],
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "链接能保留多久?",
        a: "由你在创建时选择:1 小时、1 天、3 天或 7 天,也可以设置为首次完整下载后即焚,而不是固定时长。到期之后链接就会失效。",
      },
      {
        q: "首次下载后即焚,文件真的会消失吗?",
...
const ja = {
  ...
  description:
    "ブラウザでファイルを暗号化し、サーバーが復号できないリンクを作成。有効期限は1時間・1日・3日・7日、または初回ダウンロード後に消去から選べます——準備ができたときに送れます。",
  updatedLabel: "最終更新",
  lead: [
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: ["1時間", "1日(既定値)", "3日", "7日", "または: 固定の期限の代わりに、初回の完全なダウンロード後に消去"],
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "リンクはどのくらい持ちますか?",
        a: "リンクを作成するときに選べます: 1時間、1日、3日、7日、あるいは固定の期限の代わりに初回の完全なダウンロード後に消去するよう設定できます。その時点を過ぎるとリンクは機能しなくなります。",
      },
      {
...
const ko = {
  ...
  description:
    "브라우저에서 파일을 암호화하고 서버가 복호화할 수 없는 링크를 생성하세요. 1시간·1일·3일·7일 만료 또는 첫 다운로드 후 소각 중 선택하고, 준비됐을 때 보내세요.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: ["1시간", "1일(기본값)", "3일", "7일", "또는: 고정된 시간 대신 첫 완전한 다운로드 후 소각"],
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "링크는 얼마나 유지되나요?",
        a: "링크를 만들 때 직접 선택합니다: 1시간, 1일, 3일, 7일, 또는 고정 기간 대신 첫 완전한 다운로드 후 소각으로 설정할 수 있습니다. 그 시점이 지나면 링크는 더 이상 작동하지 않습니다.",
      },
      {
...
const de = {
  ...
  description:
    "Verschlüssele eine Datei in deinem Browser und erhalte einen Link, den der Server nicht entschlüsseln kann. Wähle 1 Stunde, 1 Tag, 3 oder 7 Tage Gültigkeit oder Löschung nach dem ersten Download — sende ihn, wenn du bereit bist.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Du entscheidest beim Erstellen: 1 Stunde, 1 Tag, 3 Tage oder 7 Tage, oder du stellst statt einer festen Frist Löschung nach dem ersten vollständigen Download ein. Danach funktioniert der Link nicht mehr.",
      },
      {
...
const fr = {
  ...
  description:
    "Chiffrez un fichier dans votre navigateur et obtenez un lien que le serveur ne peut pas déchiffrer. Choisissez 1 heure, 1 jour, 3 ou 7 jours, ou l'autodestruction après le premier téléchargement, puis envoyez-le.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Vous choisissez à la création : 1 heure, 1 jour, 3 jours ou 7 jours, ou réglez une autodestruction après le premier téléchargement complet au lieu d'une durée fixe. Passé ce délai, le lien cesse de fonctionner.",
      },
      {
...
const ar = {
  ...
  description:
    "شفّر ملفاً في متصفحك واحصل على رابط لا يستطيع الخادم فك تشفيره. اختر ساعة واحدة، أو يوماً واحداً، أو 3 أيام، أو 7 أيام، أو الحذف بعد أول تنزيل، ثم أرسله متى كنت مستعداً.",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "كم تدوم الروابط؟",
        a: "تختار عند إنشاء الرابط: ساعة واحدة، أو يوماً واحداً، أو 3 أيام، أو 7 أيام، أو يمكنك ضبطه ليُحذف بعد أول تنزيل كامل بدلاً من انتهاء صلاحية ثابت. بعد تلك النقطة يتوقف الرابط عن العمل.",
      },
      {
