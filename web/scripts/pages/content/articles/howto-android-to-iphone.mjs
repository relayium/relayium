...
const en = {
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "The files you want to send, up to 10 per batch.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Pick the files to send — up to 10 per batch — or just drag them in.",
    ...
    items: [
      {
        ...
        a: "No. Relayium runs entirely in the browser on both Android and iPhone. Open relayium.com on each device and you're ready — a realtime transfer needs no account and no download. You can optionally add it to your home screen as a PWA, but that's just a shortcut.",
      },
      {
        q: "Do both phones have to be on the same Wi-Fi?",
        a: "No. The same network is the fastest path because the devices discover each other automatically, but a pairing code connects two phones across different networks — even one on mobile data and one on Wi-Fi. The transfer stays end-to-end encrypted in both cases.",
      },
      {
  ...
  cta: {
    text: "Open Relayium on both phones and send your first files across — no install, no account needed for realtime transfers.",
...
const zh = {
  ...
  lead: [
    ...
    "Relayium 把这些统统省掉。两台手机打开同一个网页，彼此发现，文件就在它们之间直接传输——端到端加密、无需安装应用、实时传输也无需账号。本文一步步带你完成。",
  ],
  sections: [
    {
      heading: "开始前需要准备什么",
      body: [
        "不用安装、不用注册。实时传输在两台设备的浏览器里直接就能用。",
      ],
      bullets: [
    ...
    },
    {
      ...
      body: [
        ...
        "发送方设备会显示一段简短的配对码，在另一台手机上输入即可（或打开它生成的分享链接）。只要条件允许，传输仍然点对点直连；当无法直连时，会退回到加密的 TURN 中继，而中继只能看到密文——所以无论哪种方式，传输都保持端到端加密。若中途连接断开，可以断点续传，而不必从头再来。",
      ],
    },
    {
  ...
  faq: {
    ...
    items: [
      {
        q: "两台手机都要装 App 吗？",
        a: "不用。Relayium 在安卓和 iPhone 上都完全运行于浏览器里。在每台设备上打开 relayium.com 就绪了——实时传输无需账号、无需下载。你也可以把它作为 PWA 添加到主屏幕，但那只是个快捷方式。",
      },
      {
        q: "两台手机必须在同一 Wi-Fi 上吗？",
        a: "不必。同一网络是最快的路径，因为设备会自动发现彼此；但配对码能把两台手机跨越不同网络连起来——哪怕一台用移动数据、一台用 Wi-Fi。两种情况下传输都保持端到端加密。",
      },
      {
        q: "照片会被压缩或改动吗？",
  ...
  cta: {
    text: "在两台手机上打开 Relayium，把第一批文件传过去吧——无需安装，实时传输也无需账号。",
...
const ja = {
  ...
  lead: [
    ...
    "Relayium はそれをすべて省きます。2台のスマホが同じ Web ページを開き、互いを見つけ、ファイルは端末間で直接転送されます——エンドツーエンド暗号化、アプリのインストール不要、リアルタイム転送ならアカウントも不要です。本記事で手順を順に説明します。",
  ],
  sections: [
    {
      heading: "始める前に必要なもの",
      body: [
        "インストールも登録も不要です。リアルタイム転送は両方の端末のブラウザからそのまま使えます。",
      ],
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "送るファイルを選びます——1バッチ最大10個——またはそのままドラッグして入れます。",
    ...
    },
    {
      ...
      body: [
        ...
        "送信側の端末が短いペアリングコードを表示するので、もう一方のスマホで入力します（または生成された共有リンクを開きます）。可能な限り転送は P2P で直接行われ、直接の経路が使えないときは暗号化された TURN リレーにフォールバックしますが、リレーが見るのは暗号文だけです——どちらの場合も転送はエンドツーエンド暗号化のままです。途中で接続が切れても、最初からではなく再開できます。",
      ],
    },
    {
    ...
    items: [
      {
        ...
        a: "いいえ。Relayium は Android でも iPhone でもすべてブラウザで動作します。各端末で relayium.com を開けば準備完了です——リアルタイム転送にアカウントもダウンロードも不要です。任意で PWA としてホーム画面に追加できますが、それはショートカットにすぎません。",
      },
      {
        q: "両方のスマホが同じ Wi-Fi にある必要がありますか？",
        a: "いいえ。同じネットワークは端末が自動的に互いを見つけるため最速の経路ですが、ペアリングコードなら2台のスマホを異なるネットワークをまたいで接続できます——一方がモバイルデータ、もう一方が Wi-Fi でも大丈夫です。どちらの場合も転送はエンドツーエンド暗号化のままです。",
      },
      {
  ...
  cta: {
    text: "両方のスマホで Relayium を開いて、最初のファイルを送ってみましょう——インストール不要、リアルタイム転送はアカウントも不要です。",
...
const ko = {
  ...
  lead: [
    ...
    "Relayium은 그 모든 것을 건너뜁니다. 두 휴대폰이 같은 웹 페이지를 열고 서로를 찾으면 파일이 기기 사이에서 직접 전송됩니다 — 종단간 암호화, 앱 설치 불필요, 실시간 전송에는 계정도 필요 없습니다. 이 글에서 단계별로 안내합니다.",
  ],
  sections: [
    {
      heading: "시작하기 전에 필요한 것",
      body: [
        "설치할 것도, 가입할 것도 없습니다. 실시간 전송은 두 기기의 브라우저에서 바로 됩니다.",
      ],
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "보낼 파일을 고릅니다 — 배치당 최대 10개 — 또는 그냥 끌어다 놓습니다.",
    ...
    },
    {
      ...
      body: [
        ...
        "보내는 기기가 짧은 페어링 코드를 표시하니, 다른 폰에서 입력하세요(또는 생성된 공유 링크를 여세요). 가능한 경우 전송은 여전히 P2P로 직접 이루어지고, 직접 경로가 없을 때는 암호화된 TURN 릴레이로 폴백하지만 릴레이는 암호문만 봅니다 — 어느 경우든 전송은 종단간 암호화를 유지합니다. 전송 중 연결이 끊겨도 처음부터가 아니라 이어서 재개할 수 있습니다.",
      ],
    },
    {
    ...
    items: [
      {
        ...
        a: "아니요. Relayium은 안드로이드와 아이폰 모두에서 전적으로 브라우저에서 동작합니다. 각 기기에서 relayium.com을 열면 준비 끝입니다 — 실시간 전송에는 계정도 다운로드도 필요 없습니다. 원하면 PWA로 홈 화면에 추가할 수 있지만, 그것은 바로가기일 뿐입니다.",
      },
      {
        q: "두 폰이 반드시 같은 Wi-Fi에 있어야 하나요?",
        a: "아니요. 같은 네트워크는 기기가 자동으로 서로를 찾기 때문에 가장 빠른 경로이지만, 페어링 코드로 두 폰을 서로 다른 네트워크를 넘어 연결할 수 있습니다 — 하나가 모바일 데이터, 다른 하나가 Wi-Fi여도 됩니다. 두 경우 모두 전송은 종단간 암호화를 유지합니다.",
      },
      {
  ...
  cta: {
    text: "두 폰에서 Relayium을 열고 첫 파일을 보내 보세요 — 설치 불필요, 실시간 전송에는 계정도 필요 없습니다.",
...
const de = {
  ...
  lead: [
    ...
    "Relayium spart dir all das. Beide Handys öffnen dieselbe Webseite, finden sich und die Dateien wandern direkt zwischen ihnen — Ende-zu-Ende-verschlüsselt, keine App zu installieren, für eine Echtzeitübertragung kein Konto. Diese Anleitung führt dich Schritt für Schritt hindurch.",
  ],
  sections: [
    {
      heading: "Was du vorher brauchst",
      body: [
        "Nichts zu installieren und nichts zu registrieren. Echtzeitübertragungen laufen direkt aus dem Browser auf beiden Geräten.",
      ],
      bullets: [
        ...
        "Die Dateien, die du senden willst, bis zu 10 pro Stapel.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Wähle die Dateien zum Senden — bis zu 10 pro Stapel — oder zieh sie einfach hinein.",
    ...
    items: [
      {
        ...
        a: "Nein. Relayium läuft auf Android und iPhone vollständig im Browser. Öffne auf jedem Gerät relayium.com, und du bist startklar — eine Echtzeitübertragung braucht kein Konto und keinen Download. Optional kannst du es als PWA zum Startbildschirm hinzufügen, aber das ist nur eine Verknüpfung.",
      },
      {
        q: "Müssen beide Handys im selben WLAN sein?",
        a: "Nein. Dasselbe Netz ist der schnellste Weg, weil sich die Geräte automatisch erkennen, aber ein Pairing-Code verbindet zwei Handys über verschiedene Netzwerke hinweg — auch eines im Mobilfunk und eines im WLAN. Die Übertragung bleibt in beiden Fällen Ende-zu-Ende-verschlüsselt.",
      },
      {
  ...
  cta: {
    text: "Öffne Relayium auf beiden Handys und schick deine ersten Dateien hinüber — keine Installation, für Echtzeitübertragungen kein Konto nötig.",
...
const fr = {
  ...
  lead: [
    ...
    "Relayium fait l'impasse sur tout cela. Les deux téléphones ouvrent la même page web, se trouvent, et les fichiers voyagent directement entre eux — chiffrés de bout en bout, aucune application à installer, aucun compte pour un transfert en temps réel. Ce guide vous accompagne pas à pas.",
  ],
  sections: [
    {
      heading: "Ce qu'il vous faut avant de commencer",
      body: [
        "Rien à installer et rien à créer. Les transferts en temps réel fonctionnent directement depuis le navigateur sur les deux appareils.",
      ],
      bullets: [
        ...
        "Les fichiers à envoyer, jusqu'à 10 par lot.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Choisissez les fichiers à envoyer — jusqu'à 10 par lot — ou faites-les simplement glisser.",
    ...
    items: [
      {
        ...
        a: "Non. Relayium fonctionne entièrement dans le navigateur, sur Android comme sur iPhone. Ouvrez relayium.com sur chaque appareil et vous êtes prêt — un transfert en temps réel ne demande ni compte ni téléchargement. Vous pouvez au choix l'ajouter à l'écran d'accueil comme PWA, mais ce n'est qu'un raccourci.",
      },
      {
        q: "Les deux téléphones doivent-ils être sur le même Wi-Fi ?",
        a: "Non. Le même réseau est la voie la plus rapide car les appareils se découvrent automatiquement, mais un code d'appairage connecte deux téléphones sur des réseaux différents — même l'un en données mobiles et l'autre en Wi-Fi. Le transfert reste chiffré de bout en bout dans les deux cas.",
      },
      {
  ...
  cta: {
    text: "Ouvrez Relayium sur les deux téléphones et envoyez vos premiers fichiers — sans installation, sans compte pour les transferts en temps réel.",
