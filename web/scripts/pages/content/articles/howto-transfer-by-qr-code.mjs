...
const ar = {
  ...
  lead: [
    "إدخال رمز من ستة خانات سريع، لكن المسح الضوئي أسرع — وجّه كاميرا الهاتف نحو الشاشة ويُهيَّأ النقل قبل أن تنتهي من الكتابة. تُظهر عملية اقتران Relayium رمز QR إلى جانب كل رمز اقتران لهذا السبب بالضبط.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "إن لم تكن الكاميرا في المتناول، يعمل الرابط نفسه ملصوقاً في أي متصفح، ويعمل الرمز المؤلف من ستة خانات مكتوباً في خانة \"أدخل الرمز\" على relayium.com. رمز QR وسيلة راحة مضافة فوق كليهما، لا آلية منفصلة — اختر أيهما أسهل في اللحظة.",
      ],
    },
    {
