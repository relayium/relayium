  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Links can be set to expire after 1 hour, 1 day, 3 days, or 7 days, or to burn after the first completed download.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "链接可设置 1 小时、1 天、3 天或 7 天后过期，也可以设为首次下载完成后即焚。",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "リンクは1時間、1日、3日、7日で失効するよう設定するか、最初のダウンロード完了後に消えるよう設定できます。",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "링크는 1시간, 1일, 3일, 7일 후 만료되도록 설정하거나, 첫 다운로드가 완료된 후 소멸하도록 설정할 수 있습니다.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Links können so eingestellt werden, dass sie nach 1 Stunde, 1, 3 oder 7 Tagen ablaufen, oder dass sie nach dem ersten vollständigen Download verfallen.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Les liens peuvent être réglés pour expirer après 1 heure, 1, 3 ou 7 jours, ou pour s'effacer après le premier téléchargement complet.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "يمكن ضبط الروابط لتنتهي صلاحيتها بعد ساعة واحدة أو يوم واحد أو 3 أيام أو 7 أيام، أو لتتلاشى بعد أول تنزيل مكتمل.",
    ...
    },
    {
      ...
      body: [
        ...
        "حين يتعذّر الاتصال المباشر — إذ يكون الطرفان خلف أنظمة NAT أو جدران حماية مقيِّدة — يلجأ التدفق المُشفَّر إلى خادم مُرحِّل TURN بدلاً من الفشل التام. لا يمرّر المُرحِّل سوى النص المُشفَّر؛ فليس لديه مفتاح ولا يمكنه فك تشفير ما يمرّ عبره. أما ما يفعله فهو عدّ البايتات التي يُرحّلها ضمن حصة الترحيل الشهرية لحساب المُرسِل، لغرض القياس ومنع إساءة الاستخدام فقط — دون أن يفحص ما بداخلها أبداً.",
      ],
    },
  ],
  faq: {
