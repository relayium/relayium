  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Where Relayium sync wins: no SSH server required (daemon direct), pinned TLS with fingerprint authentication, real-time re-sync with --watch, and it's free for every transfer mode — sync needs no account at all.",
      ],
    },
  ],
  faq: {
