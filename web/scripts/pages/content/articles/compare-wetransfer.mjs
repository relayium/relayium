...
const en = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Is Relayium free?",
        a: "The software is free and open source under the AGPL-3.0 license, with the full protocol and code at github.com/relayium/relayium, and same-network transfers are free. No plan unlocks larger realtime transfers — the size headroom comes from streaming to disk in the browser, not from a subscription. What plans do cover is hosted capacity: cross-network relay and stored download links draw on a monthly traffic allowance every account gets, plus a separate cap on how much you keep stored at once, and paid tiers raise both.",
      },
    ],
  },
  cta: {
...
const zh = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium 免费吗？",
        a: "软件采用 AGPL-3.0 许可、免费开源，完整的协议与代码都在 github.com/relayium/relayium，同一网络内的传输免费。没有哪个套餐能解锁更大的实时传输——大文件的空间来自浏览器的流式写盘，而不是订阅。套餐覆盖的是托管容量：跨网络中继与存储下载链接会占用每个账号都有的每月流量额度，以及一项独立的同时存放数据量上限，付费档位两者都更高。",
      },
    ],
  },
  cta: {
...
const ja = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "WeTransfer では、ファイルはそのサーバーにアップロードされ、しばらく保存され、そこからダウンロードされます。無料枠は1回の転送を 2 GB に制限し、リンクは管理下にないインフラ上のコピーを指します。転送は通信中も保存時も暗号化されますが、ゼロ知識ではありません。サービス側が鍵を持ち、原理的にはファイルを読めます。",
    ...
    },
    {
      ...
      bullets: [
        ...
        "費用と開放性：Relayium は AGPL-3.0 ライセンスのオープンソースで github.com/relayium/relayium にあり、ブラウザで Windows・macOS・Linux・Android・iOS で動作し、インストール不要。同じネットワーク内の転送は無料です。ネットワークをまたぐ中継と保存リンクはプランの月間転送量の枠を消費し、同時に保存しておける量には別のストレージ上限があります。有料プランではその両方が引き上げられます。",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium は無料ですか？",
        a: "ソフトウェアは AGPL-3.0 ライセンスの無料オープンソースで、プロトコルとコードのすべてが github.com/relayium/relayium にあり、同じネットワーク内の転送は無料です。どのプランでも、より大きなリアルタイム転送が解放されることはありません。大容量の余裕はブラウザのディスクへのストリーミングから来るものであり、サブスクリプションからではありません。プランが対象とするのはホスト型の容量です。ネットワークをまたぐ中継と保存ダウンロードリンクは、どのアカウントにもある月間転送量の枠と、同時に保存しておける量に対する別のストレージ上限を使い、有料プランではその両方が引き上げられます。",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "비용과 개방성: Relayium은 AGPL-3.0 라이선스의 오픈소스로 github.com/relayium/relayium에 있고, 브라우저에서 Windows·macOS·Linux·Android·iOS로 동작하며 설치가 필요 없음. 같은 네트워크 안의 전송은 무료이고, 네트워크를 넘는 중계와 저장 링크는 요금제의 월간 트래픽 허용량을 쓰며, 한 번에 저장해 둘 수 있는 양에는 별도의 저장 용량 한도가 있음. 유료 요금제는 둘 다 높여 줌.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium은 무료인가요?",
        a: "소프트웨어는 AGPL-3.0 라이선스의 무료 오픈소스이며 프로토콜과 코드 전체가 github.com/relayium/relayium에 있고, 같은 네트워크 안의 전송은 무료입니다. 어떤 요금제도 더 큰 실시간 전송을 열어 주지 않습니다. 대용량 여유는 브라우저의 디스크 스트리밍에서 오는 것이지 구독에서 오는 것이 아닙니다. 요금제가 다루는 것은 호스팅 용량입니다. 네트워크를 넘는 중계와 저장 다운로드 링크는 모든 계정에 주어지는 월간 트래픽 허용량과, 한 번에 저장해 둘 수 있는 양에 대한 별도의 저장 용량 한도를 쓰며, 유료 요금제는 둘 다 높여 줍니다.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Kosten und Offenheit: Relayium ist Open Source unter der AGPL-3.0-Lizenz auf github.com/relayium/relayium und läuft im Browser unter Windows, macOS, Linux, Android und iOS ohne Installation. Übertragungen im selben Netz sind kostenlos; netzübergreifendes Relaying und gespeicherte Links verbrauchen das monatliche Datenkontingent deines Tarifs, mit einem separaten Speicherlimit dafür, wie viel du gleichzeitig gespeichert hältst, und bezahlte Tarife erhöhen beides.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Die Software ist kostenlos und quelloffen unter der AGPL-3.0-Lizenz, mit dem vollständigen Protokoll und Code unter github.com/relayium/relayium, und Übertragungen im selben Netz sind kostenlos. Kein Tarif schaltet größere Echtzeitübertragungen frei — der Größenspielraum kommt vom Streaming auf die Festplatte im Browser, nicht von einem Abo. Was Tarife abdecken, ist gehostete Kapazität: Netzübergreifendes Relaying und gespeicherte Download-Links verbrauchen ein monatliches Datenkontingent, das jedes Konto hat, dazu ein separates Speicherlimit dafür, wie viel du gleichzeitig gespeichert hältst, und bezahlte Tarife erhöhen beides.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coût et ouverture : Relayium est open source sous licence AGPL-3.0 sur github.com/relayium/relayium, et tourne dans le navigateur sur Windows, macOS, Linux, Android et iOS sans rien installer. Les transferts sur le même réseau sont gratuits ; le relais entre réseaux et les liens stockés consomment le quota de trafic mensuel de votre offre, avec une limite de stockage distincte pour ce que vous gardez stocké à la fois, et les offres payantes relèvent les deux.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Le logiciel est gratuit et open source sous licence AGPL-3.0, avec l'intégralité du protocole et du code sur github.com/relayium/relayium, et les transferts sur le même réseau sont gratuits. Aucune offre ne débloque de plus gros transferts en temps réel — la marge de taille vient de la diffusion sur le disque dans le navigateur, pas d'un abonnement. Ce que couvrent les offres, c'est la capacité hébergée : le relais entre réseaux et les liens de téléchargement stockés puisent dans un quota de trafic mensuel dont dispose chaque compte, plus une limite de stockage distincte pour ce que vous gardez stocké à la fois, et les offres payantes relèvent les deux.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "التكلفة والانفتاح: Relayium مفتوح المصدر بموجب رخصة AGPL-3.0 على github.com/relayium/relayium، ويعمل في المتصفح على Windows وmacOS وLinux وAndroid وiOS دون أي شيء لتثبيته. النقل على نفس الشبكة مجاني؛ أما الترحيل عبر الشبكات والروابط المُخزَّنة فيستهلك حصة حركة البيانات الشهرية في خطتك، مع حدّ تخزين منفصل لما تحتفظ به مُخزَّنًا في آنٍ واحد، والخطط المدفوعة ترفع كليهما.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "هل Relayium مجاني؟",
        a: "البرنامج مجاني ومفتوح المصدر بموجب ترخيص AGPL-3.0، مع البروتوكول والشيفرة كاملين على github.com/relayium/relayium، والنقل على نفس الشبكة مجاني. لا تفتح أي خطة نقلات فورية أكبر — فمتّسع الحجم يأتي من البث إلى القرص في المتصفح، لا من اشتراك. ما تغطيه الخطط هو السعة المُستضافة: فالترحيل عبر الشبكات وروابط التنزيل المُخزَّنة تستهلك حصة حركة البيانات الشهرية التي يحصل عليها كل حساب، إضافةً إلى حدّ تخزين منفصل لما تحتفظ به مُخزَّنًا في آنٍ واحد، والخطط المدفوعة ترفع كليهما.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Coste y apertura: Relayium es de código abierto con licencia AGPL-3.0 en github.com/relayium/relayium, y se ejecuta en el navegador en Windows, macOS, Linux, Android e iOS sin nada que instalar. Las transferencias en la misma red son gratis; la retransmisión entre redes y los enlaces almacenados consumen la franquicia mensual de tráfico de tu plan, con un límite de almacenamiento aparte para lo que guardas almacenado a la vez, y los planes de pago amplían ambos.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "El software es gratis y de código abierto bajo la licencia AGPL-3.0, con el protocolo y el código completos en github.com/relayium/relayium, y las transferencias en la misma red son gratis. Ningún plan desbloquea transferencias en tiempo real más grandes: el margen de tamaño viene de transmitir al disco en el navegador, no de una suscripción. Lo que cubren los planes es la capacidad alojada: la retransmisión entre redes y los enlaces de descarga almacenados consumen una franquicia mensual de tráfico que tiene cada cuenta, más un límite de almacenamiento aparte para lo que guardas almacenado a la vez, y los planes de pago amplían ambos.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Custo e abertura: o Relayium é de código aberto sob a licença AGPL-3.0 em github.com/relayium/relayium, e roda no navegador em Windows, macOS, Linux, Android e iOS sem nada para instalar. Transferências na mesma rede são gratuitas; a retransmissão entre redes e os links armazenados consomem a cota mensal de tráfego do seu plano, com um limite de armazenamento separado para o que você mantém armazenado ao mesmo tempo, e os planos pagos aumentam ambos.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "O software é gratuito e de código aberto sob a licença AGPL-3.0, com o protocolo e o código completos em github.com/relayium/relayium, e as transferências na mesma rede são gratuitas. Nenhum plano desbloqueia transferências em tempo real maiores — a folga de tamanho vem da transmissão para o disco no navegador, não de uma assinatura. O que os planos cobrem é a capacidade hospedada: a retransmissão entre redes e os links de download armazenados consomem uma cota mensal de tráfego que toda conta tem, mais um limite de armazenamento separado para o que você mantém armazenado ao mesmo tempo, e os planos pagos aumentam ambos.",
      },
    ],
  },
  cta: {
