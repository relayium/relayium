  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Cost and openness: Relayium is free and MIT-licensed at github.com/relayium/relayium, and runs in the browser on Windows, macOS, Linux, Android and iOS with nothing to install.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "Is Relayium free?",
        a: "Yes. Relayium is free and open source under the MIT license, with the full protocol and code at github.com/relayium/relayium. There is no paid tier to unlock larger realtime transfers — the size headroom comes from streaming to disk in the browser, not from a subscription.",
      },
    ],
  },
  cta: {
...
const zh = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium 免费吗？",
        a: "免费。Relayium 采用 MIT 许可，是免费开源软件，完整的协议与代码都在 github.com/relayium/relayium。没有付费档去解锁更大的实时传输——大文件的空间来自浏览器的流式写盘，而不是订阅。",
      },
    ],
  },
  cta: {
...
const ja = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium は無料ですか？",
        a: "はい。Relayium は MIT ライセンスの無料オープンソースで、プロトコルとコードのすべてが github.com/relayium/relayium にあります。より大きなリアルタイム転送を解放する有料プランはありません——大容量の余裕はブラウザのディスクへのストリーミングから来るものであり、サブスクリプションからではありません。",
      },
    ],
  },
  cta: {
...
const ko = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Relayium은 무료인가요?",
        a: "네. Relayium은 MIT 라이선스의 무료 오픈소스이며, 프로토콜과 코드 전체가 github.com/relayium/relayium에 있습니다. 더 큰 실시간 전송을 여는 유료 등급은 없습니다——대용량 여유는 브라우저의 디스크 스트리밍에서 오는 것이지 구독에서 오는 것이 아닙니다.",
      },
    ],
  },
  cta: {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "التكلفة والانفتاح: Relayium مجاني ومرخّص بـ MIT على github.com/relayium/relayium، ويعمل في المتصفح على Windows وmacOS وLinux وAndroid وiOS دون أي شيء لتثبيته.",
      ],
    },
  ],
  faq: {
    ...
    items: [
      ...
      {
        q: "هل Relayium مجاني؟",
        a: "نعم. Relayium مجاني ومفتوح المصدر بموجب ترخيص MIT، مع البروتوكول والشيفرة كاملين على github.com/relayium/relayium. لا فئة مدفوعة لفتح نقلات فورية أكبر — فمتّسع الحجم يأتي من البث إلى القرص في المتصفح، لا من اشتراك.",
      },
    ],
  },
  cta: {
