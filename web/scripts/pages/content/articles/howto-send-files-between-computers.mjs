  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "送るファイルまたはフォルダを選びます——1バッチ最大1,000ファイル。Relayium が6桁のペアリングコード（対応する参加リンク／QRコード付き）を発行します。",
        "そのコードやリンクを都合の良い方法で相手に伝えます——読み上げる、テキストメッセージで送る、チャットに貼り付けるなど。",
        "受信側のパソコンで、リンクを開くか、relayium.com を開いて6桁のコードを入力します。こちら側にサインインは不要です。",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Choisissez les fichiers ou le dossier à envoyer — jusqu'à 1 000 fichiers par lot. Relayium génère un code d'appairage à 6 chiffres (avec le lien de participation/QR code correspondant).",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "اختر الملفات أو المجلد المراد إرساله — حتى 1000 ملف في الدفعة الواحدة. يُنشئ Relayium رمز اقتران من 6 أرقام (ورابط انضمام/رمز QR مطابقاً له).",
