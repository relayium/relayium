...
// released publicly under its own tag namespace (currently `macos-v1.3.7`, a
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "The macOS app is released under its own tag, macos-v1.3.7: a Developer ID-signed, Apple-notarized direct download from GitHub. The separately versioned Mac App Store release is currently 1.3.1. No version below ships either app. The iOS app is an engineering build and has not been released publicly.",
...
const zh = {
  ...
  otherDocLabel: "隐私政策",
  lead: [
    "Relayium 有三种发布节奏，这一页对三种都如实说明：网页版持续部署，命令行工具带版本号打标签发布，原生应用则各自单独发布——macOS 1.3.7 已可从 GitHub 下载，iOS 应用仍是开发版，尚未公开发布。",
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "macOS 应用用自己的标签 macos-v1.3.7 单独发布：这是一份经过 Developer ID 签名、通过 Apple 公证、直接从 GitHub 下载的安装包。独立维护版本号的 Mac App Store 版本当前为 1.3.1。下面任何一个版本都不包含这些应用。iOS 应用仍是开发版，尚未公开发布。",
