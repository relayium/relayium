...
//
// The prose deliberately says what a version number does NOT cover. A tag
// publishes the two binaries goreleaser builds from server/ (.goreleaser.yaml);
// the web app deploys continuously from main and has no version at all, and the
// native apps are engineering builds that ship in no tag. Listing "web app" or
// "macOS" against v0.15.0 would have been the easy, untrue version of this page.
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "The macOS and iOS apps are engineering builds, not public releases. No version below ships them.",
...
const ko = {
  ...
  lead: [
    "Relayium은 세 가지 리듬으로 배포되며, 이 페이지는 셋 모두를 있는 그대로 밝힙니다. 웹 앱은 계속 배포되고, 명령줄 도구는 번호를 붙여 릴리스하며, 네이티브 앱은 아직 공개되지 않은 개발 빌드입니다.",
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "macOS와 iOS 앱은 개발 빌드이며 공개 릴리스가 아닙니다. 아래 어떤 버전에도 포함되어 있지 않습니다.",
...
const fr = {
  ...
  lead: [
    "Relayium avance à trois rythmes, et cette page les décrit honnêtement tous les trois : l'application web est déployée en continu, les outils en ligne de commande sont numérotés et publiés, et les applications natives restent des versions d'ingénierie qui ne sont pas encore diffusées publiquement.",
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "Les applications macOS et iOS sont des versions d'ingénierie, pas des publications publiques. Aucune version ci-dessous ne les contient.",
...
const ar = {
  ...
  lead: [
    "يصدر Relayium بثلاثة إيقاعات، وهذه الصفحة تذكرها الثلاثة بصراحة: تطبيق الويب يُنشر باستمرار، وأدوات سطر الأوامر تحمل أرقامًا وعلامات إصدار، والتطبيقات الأصلية ما تزال نسخ تطوير لم تُنشر للعموم بعد.",
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "تطبيقا macOS وiOS نسختا تطوير، وليسا إصدارين عامّين. ولا يتضمنهما أي إصدار في الأسفل.",
...
const es = {
  ...
  lead: [
    "Relayium avanza a tres ritmos, y esta página los cuenta los tres con honestidad: la aplicación web se despliega de forma continua, las herramientas de línea de comandos llevan número y etiqueta, y las aplicaciones nativas siguen siendo compilaciones de ingeniería que aún no se han publicado.",
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "Las aplicaciones de macOS e iOS son compilaciones de ingeniería, no publicaciones públicas. Ninguna versión de abajo las incluye.",
...
const pt = {
  ...
  lead: [
    "O Relayium sai em três ritmos, e esta página conta os três com honestidade: o app web é implantado continuamente, as ferramentas de linha de comando recebem número e tag, e os apps nativos ainda são builds de engenharia que não foram publicados.",
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "Os apps de macOS e iOS são builds de engenharia, não publicações públicas. Nenhuma versão abaixo os inclui.",
