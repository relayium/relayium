...
public enum L10nKey: String, CaseIterable, Sendable {
    ...
    case sendErrorUploadQuota = "send.errorUploadQuota"
    case sendErrorUploadDailyQuota = "send.errorUploadDailyQuota"
    case sendErrorUploadMonthlyTraffic = "send.errorUploadMonthlyTraffic"
    case sendErrorUploadRateLimited = "send.errorUploadRateLimited"
