...
final class MacSurfaceGuardTests: XCTestCase {
    ...
    func testTheDocsStateTheIOSEngineeringBuildStatusOutright() throws {
        ...
        XCTAssertTrue(apps.contains("**In development at 0.4.0 and not public**"),
        ...
        XCTAssertTrue(root.contains("`apps/ios/` exists in this repository and its development has **resumed**, at version `0.4.0`"),
