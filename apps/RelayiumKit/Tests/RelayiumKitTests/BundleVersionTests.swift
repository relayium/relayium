...
final class BundleVersionTests: XCTestCase {
    ...
    func testTheMacAppAndItsExtensionShipOneVersion() throws {
        ...
        try assertOneVersion("mac", key: "MARKETING_VERSION", expected: "1.3.0", occurrences: 10)
        try assertOneVersion("mac", key: "CURRENT_PROJECT_VERSION", expected: "18", occurrences: 10)
    }
