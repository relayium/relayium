...
final class BundleVersionTests: XCTestCase {
    ...
    func testTheMacAppAndItsExtensionShipOneVersion() throws {
        ...
        try assertOneVersion("mac", key: "MARKETING_VERSION", expected: "1.2.11", occurrences: 10)
        try assertOneVersion("mac", key: "CURRENT_PROJECT_VERSION", expected: "17", occurrences: 10)
    }
