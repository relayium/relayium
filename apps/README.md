...
- `mac/RelayiumShare/` — the macOS Share Extension (`com.relayium.mac.Share`),
  ...
  inside the released 1.2.3 app. The system Share menu is verified to list it; a
...
**Status: released as 1.2.3.** The owner reviewed and installed the notarized
...
exact-SHA, universal, sandboxed, App Store-signed 1.2.3 (10) package is built and
verified locally — but it has not been uploaded, so App Store Connect and
TestFlight hold nothing for this version. See
...
provisioning profile. That profile now exists — it produced the signed 1.2.3 (10)
