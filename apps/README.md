...
- `mac/` — macOS SwiftUI app (`com.relayium.mac`), depends on the local RelayiumKit
  package. Released publicly as **1.2.4** (GitHub Release `macos-v1.2.4`).
- `mac/RelayiumShare/` — the macOS Share Extension (`com.relayium.mac.Share`),
  ...
  inside the released 1.2.4 app. The system Share menu is verified to list it; a
...
**Status: released as 1.2.4.** The owner requested this 1.2.4 release, the
...
verified locally, and uploaded to App Store Connect on 2026-08-15, where it is
processing for internal TestFlight. It has not been submitted for App Review, and
