...
- `mac/` — macOS SwiftUI app (`com.relayium.mac`), depends on the local RelayiumKit
  package. Released publicly as **1.3.8** (GitHub Release `macos-v1.3.8`).
- `mac/RelayiumShare/` — the macOS Share Extension (`com.relayium.mac.Share`),
  ...
  inside the released 1.3.8 app. The system Share menu is verified to list it; a
...
**Status: released as 1.3.8.** The owner requested this 1.3.8 release, the
