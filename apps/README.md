...
- `mac/` — macOS SwiftUI app (`com.relayium.mac`), depends on the local RelayiumKit
  package. Released publicly as **1.2.11** (GitHub Release `macos-v1.2.11`).
- `mac/RelayiumShare/` — the macOS Share Extension (`com.relayium.mac.Share`),
  ...
  inside the released 1.2.11 app. The system Share menu is verified to list it; a
...
- `ios/RelayiumShare/` — the iOS Share Extension (`com.relayium.app.share`),
  ...
  only. In development and not public. It has run on a physical iPad, where a
  real system share reached the containing app; coverage of real iPhone Photos,
  Files and third-party providers is still open.
...
**Status: released as 1.2.11.** The owner requested this 1.2.11 release, the
