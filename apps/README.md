...
- `mac/` — macOS SwiftUI app (`com.relayium.mac`), depends on the local RelayiumKit
  package. Released publicly as **1.2.7** (GitHub Release `macos-v1.2.7`).
- `mac/RelayiumShare/` — the macOS Share Extension (`com.relayium.mac.Share`),
  ...
  inside the released 1.2.7 app. The system Share menu is verified to list it; a
...
**Status: released as 1.2.7.** The owner requested this 1.2.7 release, the
