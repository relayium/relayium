...
**1.3.7**: a universal, Developer ID-signed, Apple-notarized and stapled
build, published as a direct download from its own GitHub Release,
[`macos-v1.3.7`](https://github.com/relayium/relayium/releases/tag/macos-v1.3.7).
...
| **macOS** | [1.3.7 direct download](https://github.com/relayium/relayium/releases/tag/macos-v1.3.7) and [1.3.1 on the Mac App Store](https://apps.apple.com/app/id6801142976) | The independently versioned channels share product behavior but use Developer ID/Sparkle and Mac App Store/StoreKit delivery respectively. |
