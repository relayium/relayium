...
**1.2.11**: a universal, Developer ID-signed, Apple-notarized and stapled
build, published as a direct download from its own GitHub Release,
[`macos-v1.2.11`](https://github.com/relayium/relayium/releases/tag/macos-v1.2.11).
...
| **macOS** | [1.2.11 direct download](https://github.com/relayium/relayium/releases/tag/macos-v1.2.11) | Universal, signed and notarized. The public channel is the Developer ID download with signed in-app updates; there is no public Mac App Store listing. |
