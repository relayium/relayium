...
| **macOS** | [1.3.8 direct download](https://github.com/relayium/relayium/releases/tag/macos-v1.3.8) and [1.3.1 on the Mac App Store](https://apps.apple.com/app/id6801142976) | The independently versioned channels share product behavior but use Developer ID/Sparkle and Mac App Store/StoreKit delivery respectively. |
