...
**1.2.3**: a universal, Developer ID-signed, Apple-notarized and stapled
...
- **macOS — 1.2.3, published as a direct download:** the universal app supports account
  ...
  express. The 1.2.3 DMG is universal, Developer ID-signed, accepted by Apple
