...
**1.3.0**: a universal, Developer ID-signed, Apple-notarized and stapled
...
| **macOS** | [1.3.0 direct download](https://github.com/relayium/relayium/releases/tag/macos-v1.3.0) | Universal, signed and notarized. The public channel is the Developer ID download with signed in-app updates; there is no public Mac App Store listing. |
