...
**1.4.3**: a Developer ID-signed, Apple-notarized and stapled build, published
...
**resumed**, at version `0.5.0`. It has never been publicly released — there is
...
`0.3.0` (versionCode 9), offered as a **public preview** distributed as a direct
